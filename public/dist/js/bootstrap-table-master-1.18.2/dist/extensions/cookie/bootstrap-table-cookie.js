	...
	var UtilsCookie = {
	  ...
	  setCookie: function setCookie(that, cookieName, cookieValue) {
	    ...
	    switch (that.options.cookieStorage) {
	      case 'cookieStorage':
	        document.cookie = [cookieName, '=', encodeURIComponent(cookieValue), "; expires=".concat(UtilsCookie.calculateExpiration(that.options.cookieExpire)), "; path=".concat('/'), that.options.cookieDomain ? "; domain=".concat(that.options.cookieDomain) : '', that.options.cookieSecure ? '; secure' : '', ";SameSite=".concat(that.options.cookieSameSite)].join('');
	        break;
