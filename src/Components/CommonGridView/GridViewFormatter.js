...
export const BLBCFormatterDocNum = (value, row, index) => {
  ...
  if (value == null) {
    ...
    if ((window.location.pathname).includes("third-party")) {
      if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
        return "<a href='../../../../sales/standard/booking-reservation-barge/update/id=" + id + "' class='checkPermissionLinkBR' target='_blank'>" + value + "</a>";
      }
      else {
        return "<a href='../../../../sales/container/booking-reservation/update/id=" + id + "' class='checkPermissionLinkBR' target='_blank'>" + value + "</a>";
      }
...
export const BLDocFormatterDocNumBR = (value, row, index) => {
  if (row.BillOfLadingDocNum != null) {
    if (row.BillOfLadingDocNum == null) {
      ...
      var id = row.BillOfLadingUUID;
      if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
        return "<a href='../../../operation/standard/bill-of-lading-barge/update/id=" + id + "' class = 'checkPermissionLinkBL' target='_blank'>" + value + "</a>"
      } else {
        return "<a href='../../../operation/container/bill-of-lading/update/id=" + id + "' class = 'checkPermissionLinkBL' target='_blank'>" + value + "</a>"
      }
    }
  }
  else {
...
export const QuotationFormatterDocNum = (value, row, index) => {
  ...
  if (row.Quotation == null) {
    ...
    if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
      return "<a href='../quotation-barge/update/id=" + row.Quotation + "' class = 'checkPermissionLinkQT' target='_blank'>" + value + "</a>";
    } else {
      return "<a href='../quotation/update/id=" + row.Quotation + "' class = 'checkPermissionLinkQT' target='_blank'>" + value + "</a>";
    }
    ...
    $.each(arrayDocNum, function (key, value) {
      $.each(arrayUUID, function (key2, value2) {
        if (key == key2) {
          ...
          if ((window.location.pathname).includes("third-party")) {
            if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
              LinkID += "<a href='../../../../sales/standard/sales-invoice-barge/update/id=" + value2 + "' class='checkPermissionLinkINV' target='_blank'>" + value + "</a>, ";
            }
            else {
              LinkID += "<a href='../../../../sales/container/sales-invoice/update/id=" + value2 + "' class='checkPermissionLinkINV' target='_blank'>" + value + "</a>, ";
            }
...
export const haulierFommatter = (value, row, index) => {
  if(row.Status == "Reserved" || row.Status == "Discharged"){
    return "<a href='javascript:void(0)' data-toggle='modal' data-target='#HaulierGateOutModal'><i class='fa fa-truck'></i></a> ";
  }else{
    return "<a href='javascript:void(0)' data-toggle='modal' disabled='true'><i class='fa fa-truck' style='color: gray;'`></i></a> ";
  }
}
...
export const voyageDelayFormatter = (value, row, index) => {
  ...
  if (row.VoyageUpdatedAt !== null && row.VoyageCheckAt == null) {
    actionButtons += '<a href="./update/id=' + row.id + '&D=1"  "title="Voyge Delay"><i class="fa fa-ship" style="color:orange"></i></a> ';
  }
...
export const INVFormatterDocNum = (value, row, index) => {
  if (row.SalesInvoiceUUID == null) {
    ...
    if ((window.location.pathname).includes("third-party")) {
      if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
        return "<a href='../../../standard/sales-invoice-barge/update/id=" + row.SalesInvoiceUUID + "' target='_blank'>" + value + "</a>";
      }
      else {
        return "<a href='../../../container/sales-invoice/update/id=" + row.SalesInvoiceUUID + "' target='_blank'>" + value + "</a>";
      }

    } else {
      if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
        return "<a href='../sales-invoice-barge/update/id=" + row.SalesInvoiceUUID + "' target='_blank'>" + value + "</a>";
      }
      else if(((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("g-p-export"))){
        if(row.Barge=="1"){
          return "<a href='../../sales/standard/sales-invoice-barge/update/id=" + row.SalesInvoiceUUID + "' target='_blank'>" + value + "</a>";
        }else{
          return "<a href='../../sales/container/sales-invoice/update/id=" + row.SalesInvoiceUUID + "' target='_blank'>" + value + "</a>";
        } 
      }
      else {
...
export const INVFormatterDocNumSelf = (value, row, index) => {
  if (row.SalesInvoiceUUID == null) {
    ...
    if ((window.location.pathname).includes("third-party")) {
      if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
        return "<a href='../../../standard/sales-invoice-barge/update/id=" + row.SalesInvoiceUUID + "&thirdparty=1' target='_blank'>" + value + "</a>";
      }
      else {
        return "<a href='../../../container/sales-invoice/update/id=" + row.SalesInvoiceUUID + "&thirdparty=1' target='_blank'>" + value + "</a>";
      }
...
export const CNFormatterDocNum = (value, row, index) => {
  if (row.SalesCreditNoteUUID == null) {
    ...
    if (row.IsBarge == "1") {
      return "<a href='../credit-note-barge/update/id=" + row.SalesCreditNoteUUID + "' target='_blank'>" + value + "</a>";
    }
    else {
...
export const CNFormatterDocNum2 = (value, row, index) => {
  if (row.SalesCreditNoteUUID == null) {
    ...
    if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
      ...
      if(row.Barge=="1"){
        return "<a href='../../sales/standard/credit-note-barge/update/id=" + row.SalesCreditNoteUUID + "' target='_blank'>" + value + "</a>";
      }else{
        return "<a href='../../sales/container/credit-note/update/id=" + row.SalesCreditNoteUUID + "' target='_blank'>" + value + "</a>";
      } 
    }
    else {
      return "<a href='../credit-note/update/id=" + row.SalesCreditNoteUUID + "' target='_blank'>" + value + "</a>";
...
export const CROQTFormatterDocNum = (value, row, index) => {
  if (value == null) {
    ...
    if ((window.location.pathname).includes("third-party")) {
      if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
        return "<a href='../../../../sales/standard/quotation-barge/update/id=" + id + "' class='checkPermissionLinkQT' target='_blank'>" + value + "</a>";
      }
      else {
        return "<a href='../../../../sales/container/quotation/update/id=" + id + "' class='checkPermissionLinkQT' target='_blank'>" + value + "</a>";
      }
...
export const DBFormatterDocNum = (value, row, index) => {
  if (row.SalesDebitNoteUUID == null) {
    ...
    if (row.IsBarge == "1") {
      return "<a href='../debit-note-barge/update/id=" + row.SalesDebitNoteUUID + "' target='_blank'>" + value + "</a>";
    }
    else {
...
export const DBFormatterDocNum2 = (value, row, index) => {
  if (row.SalesDebitNoteUUID == null) {
    ...
    // else {
    if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
      return "<a href='../debit-note-barge/update/id=" + id + "' target='_blank'>" + value + "</a>";
    } else {
      return "<a href='../debit-note/update/id=" + id + "' target='_blank'>" + value + "</a>";
    }
    //}
...
export const DBFormatterDocNumSelf = (value, row, index) => {
  if (row.SalesDebitNoteUUID == null) {
    ...
    if ((window.location.pathname).includes("third-party")) {
      if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
        return "<a href='../../../standard/debit-note-barge/update/id=" + id + "&thirdparty=1' target='_blank'>" + value + "</a>";
      }
      else {
        return "<a href='../../../container/debit-note/update/id=" + id + "&thirdparty=1' target='_blank'>" + value + "</a>";
      }
    ...
    if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
      return "<a href='../debit-note-barge/update/id=" + id + "' target='_blank'>" + value + "</a>";
        ...
        if(row.Barge=="1"){
          return "<a href='../../sales/standard/debit-note-barge/update/id=" + id + "' target='_blank'>" + value + "</a>";
        }else{
          return "<a href='../../sales/container/debit-note/update/id=" + id + "' target='_blank'>" + value + "</a>";
        } 
    }else {
      return "<a href='../debit-note/update/id=" + id + "' target='_blank'>" + value + "</a>";
    }
  ...
  if (row.BillOfLadingDocNum == null) {
    ...
    if ((window.location.pathname).includes("third-party")) {
      ...
      if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
        ...
        if(row.Barge=="1"){
          return "<a href='../../operation/standard/bill-of-lading-barge/update/id=" + id + "' target='_blank'>" + value + "</a>";
        }else{
          return "<a href='../../operation/container/bill-of-lading/update/id=" + id + "' target='_blank'>" + value + "</a>";
        } 
      }
      else {
        return "<a href='../../../operation/container/bill-of-lading/update/id=" + id + "' class = 'checkPermissionLinkBL' target='_blank'>" + value + "</a>"
...
export const DeliveryOrderFormatterDocNum = (value, row, index) => {
  if (value == null) {
    ...
    if ((window.location.pathname).includes("third-party")) {
      if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
        return "<a href='../../../../operation/standard/delivery-order-barge/update/id=" + row.DeliveryOrderUUID + "' class = 'checkPermissionLinkDO' target='_blank'>" + value + "</a>"
      }
      else {
        return "<a href='../../../../operation/container/delivery-order/update/id=" + row.DeliveryOrderUUID + "' class = 'checkPermissionLinkDO' target='_blank'>" + value + "</a>"
      }

    } 
    else{
      if (((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("barge"))) {
        return "<a href='../../../operation/container/delivery-order-barge/update/id=" + row.DeliveryOrderUUID + "'  class='checkPermissionLinkDO' target='_blank'>" + value + "</a>";
      }
      else if(((window.location.pathname).substring(0, (window.location.pathname).lastIndexOf('/')).includes("g-p-export"))){
        if(row.Barge=="1"){
          return "<a href='../../operation/standard/delivery-order-barge/update/id=" + row.DeliveryOrderUUID + "' target='_blank'>" + value + "</a>";
        }else{
          return "<a href='../../operation/container/delivery-order/update/id=" + row.DeliveryOrderUUID + "' target='_blank'>" + value + "</a>";
        } 
      }
      else {
        return "<a href='../../../operation/container/delivery-order/update/id=" + row.DeliveryOrderUUID + "'  class='checkPermissionLinkDO' target='_blank'>" + value + "</a>";
