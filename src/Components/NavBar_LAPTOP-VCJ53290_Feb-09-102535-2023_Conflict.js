    ...
    return (
        ...
        <div>
            <nav className="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <ul className="navbar-nav">
                    ...
                    <div className="user-panel d-flex">
                        <div class="image">
                            <img id="logo" class="img-circle mt-1" style={{ width: "40px" }} src={Logo} />
                        </div>
                        <div className="info">
...

                        {
                            ...
                            return (item.level2.length > 0) ? (
                                <li className="nav-item dropdown" key={index}>
                                    <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" className={item.className}><i className={item.icon} />{item.Title}</a>
                                        ...
                                        {item.level2.map((item2, index2) => {
                                            ...
                                            if (item2.level3.length > 0) {
                                                ...
                                                return <li className="dropdown-submenu dropdown-hover" key={index2}>
                                                     {item2.title=="Company"?<Link to={item2.link} className="dropdown-item dropdown-toggle"><i className="fas fa-angle-right nav-icon mr-2" />{item2.title}</Link>:<a className="dropdown-item dropdown-toggle"><i className="fas fa-angle-right nav-icon mr-2" />{item2.title}</a>}
                                                        ...
                                                        {item2.level3.map((item3, index3) => {
                                                            ...
                                                            if (item3.level4.length > 0) {
                                                                return (
                                                                    ...
                                                                    <li class="dropdown-submenu dropdown-hover" key={index3}>
                                                                       
                                                                        <a id="dropdownSubMenu2" href="#" role="button" class="dropdown-item dropdown-toggle"><i class="fas fa-angle-double-right nav-icon mr-2"></i>{item3.title}</a>
                                                                        <ul class="dropdown-menu leftList2">
                                                                            {item3.level4.map((item4, index4) => {
                                                                                return (
                                                                                    <li key={index4}>
                                                                                        <Link to={item4.link} class="dropdown-item"> <i class="fas fa-caret-right nav-icon mr-2"></i>{item4.title}</Link>
                                                                                    </li>
                                                                                )
                                                                            })}
                                                                        </ul>
                                                                ...
                                                                return <li key={index3}><Link to={item3.link} className="dropdown-item"><i className="fas fa-angle-double-right nav-icon mr-2"></i>{item3.title}</Link></li>
                                                            }
                                                        })}
                                                ...
                                                return <li key={index2}><Link to={item2.link} className={item2.className}><i className={item2.icon}></i>{item2.title}</Link></li>
                                            }
                ...
                <ul className="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                   ...
                   <div className="user-panel d-flex ml-2">
                        <div class="image">
                            <img id="img" class="img-circle elevation-2 mt-1" src={globalContext.profileImage ? globalContext.profileImage : UserPng} />
                    ...
                    <li className="nav-item">
                        <button className="nav-link" style={{ border: 'none', background: 'white' }}><i style={{ color: '#007BFF' }} className="fas fa-power-off" onClick={handleLogOut} /></button>
                    </li>
                </ul>
            ...
            <Routes>
                ...
                <Route path="/movement/container/report/real-time-tracking/index" element={<Content Title="Real Time Tracking" ContentLink='Pages/RealTimeTracking/Index' modelLink="RealTimeTracking" groupLink="/movement/container/report/" />} />
                <Route path="/movement/container/report/history-tracking/index" element={<Content Title="History Tracking" ContentLink='Pages/HistoryTracking/Index' modelLink="RealTimeTracking" groupLink="/movement/container/report/" />} />
                ...
                <Route path="/operation/standard/bill-of-lading-barge/index" element={<Content Title="Bill Of Lading" model="BillOfLading" directory="same" ContentLink='CommonGridView/GridView' tableId="bill-of-lading-barge" columnSetting="bill-of-lading-barge" groupLink="/operation/standard/" />} />       
                ...
                <Route path="/operation/report/lifting/index" element={<Content Title="Lifting" ContentLink='CommonForm/Lifting' directory="same" header="Lifting" model="Lifting" modelLink="lifting" groupLink="/operation/report/" />} />
                <Route path="/operation/report/lifting-summary/index" element={<Content Title="Lifting Summary" ContentLink='CommonForm/Lifting' directory="same" header="LiftingSummary" model="LiftingSummary" modelLink="lifting-summary" groupLink="/operation/report/" />} /> 
                <Route path="/operation/report/vessel-voyage-lifting/index" element={<Content Title="Vessel Voyage Lifting" ContentLink='CommonForm/Lifting' directory="same" header="VesselVoyageLifting" model="VesselVoyageLifting" modelLink="vessel-voyage-lifting" groupLink="/operation/report/" />} /> 
                <Route path="/operation/report/customer-lifting/index" element={<Content Title="Customer Lifting" ContentLink='Pages/CustomerLifting/Form' header="CustomerLifting" model="CustomerLifting" modelLink="customer-lifting" groupLink="/operation/report/" />} />  
                ...
                <Route path="/movement/container/container-gate-in/index" element={<Content Title="Container Gate In" model="ContainerGateIn" directory="same" ContentLink='CommonGridView/GridViewMovement' tableId="container-gate-in" columnSetting="container-gate-in" groupLink="/movement/container/" />} />
                <Route path="/movement/container/container-loaded/index" element={<Content Title="Container Loaded" model="ContainerLoaded" directory="same" ContentLink='CommonGridView/GridViewMovement' tableId="container-loaded" columnSetting="container-loaded" groupLink="/movement/container/" />} />                                    
                <Route path="/movement/container/container-discharged/index" element={<Content Title="Container Loaded" model="ContainerDischarged" directory="same" ContentLink='CommonGridView/GridViewMovement' tableId="container-discharged" columnSetting="container-discharged" groupLink="/movement/container/" />} />     
                <Route path="/movement/container/container-gate-out/index" element={<Content Title="Container Gate Out" model="ContainerGateOut" directory="same" ContentLink='CommonGridView/GridViewMovement' tableId="container-gate-out" columnSetting="container-gate-out" groupLink="/movement/container/" />} />
                <Route path="/movement/container/container-receive/index" element={<Content Title="Empty Return" model="ContainerReceive" directory="same" ContentLink='CommonGridView/GridViewMovement' tableId="container-receive" columnSetting="container-receive" groupLink="/movement/container/" />} />
