...
import DetailFormMultiplePODField from "./DetailFormMultiplePODField";
...
function DetailFormInstructionMultiplePOD(props) {
    ...
    <>
        {props.InstructionItem.instructionList.map((res, index) => {
                ...
                // ];
                 ...
                 var PODMultipleElement=[   {type:"MultiplePOD"}]
                    ...
                    <div key={index} className={`${lowercaseFormName}-${lowercaseInstructionType}-form`}>
                        <div className="card lvl2">
                            ...
                            <div className="card-body">
                                <div className="row">
                                    <BuildUIForInstruction props={props} element={instructionType=="POL"? 
                                                                                    POLElement : instructionType=="POD"?
                                                                                    PODMultipleElement:
                                                                                    props.InstructionItem.formName=="ContainerReleaseOrder"?
                                                                                    VoyageElementNoDND:
                                                                                    (props.InstructionItem.formNameBarge=="SalesCreditNoteBarge" || props.InstructionItem.formNameBarge=="SalesDebitNoteBarge" || props.InstructionItem.formNameBarge=="SalesInvoiceBarge")?
                                                                                    VoyageElementBarge:(props.InstructionItem.formNameBarge=="DeliveryOrderBarge")?
                                                                                    VoyageElementBargeDO:(props.InstructionItem.formNameBarge=="BillOfLadingBarge" || props.InstructionItem.formNameBarge=="QuotationBarge" || props.InstructionItem.formNameBarge=="BookingReservationBarge")?
                                                                                    VoyageElementBargeBL:VoyageElement} cardIndex={index}/>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default DetailFormInstructionMultiplePOD
        ...
        <>
            {props.element.map((res, index) => {
                    ...
                    return res.type === "input-text" ? (
										...
										) : res.type === "MultiplePOD" ? (
											<div>
												<DetailFormMultiplePODField
													formName={formName}
													register={props.props.register}
													control={props.props.control}
													errors={props.props.errors}
													setValue={props.props.setValue}
													port={props.props.port}
													getValues={props.props.getValues}
												/>
											</div>
											...
											<div key={index} className={res.gridSize}>
												<div
													...
													<input
														type={"checkbox"}
														className={`mt-1 ${
															res.checkBoxClass ? res.checkBoxClass : ""
														}`}
														id={res.id}
														onChange={CheckBoxHandle}
														defaultChecked={
															res.specialFeature.includes("defaultCheck")
																? true
																: false
														}></input>
													<input
