...
import { CheckBoxHandle, ControlOverlay, LoadTariff, GetUpdateData, CreateData, GetCOCCompaniesData, createCookie, getCookie, getAreaById, getPortDetails, GetCompaniesData, getCompanyDataByID, GetBranchData, getUNNumberByID, getHSCodeByID, getContainers, getChargesByContainerTypeAndPortCode, getContainerTypeById, getBCChargesDescription, sortArray } from '../../Components/Helper.js'
import FormContext from "./FormContext";
import GlobalContext from "../GlobalContext"
import $ from "jquery";
import axios from "axios"
import { ShareContainerModelMultiplePOD } from "../BootstrapTableModal&Dropdown/ShareContainerModelMultiplePOD";
import NestedTableChargesMultiplePOD from './NestedTableChargesMultiplePOD.js';
import NestedTableChargesINV from './NestedTableChargesINV.js';
import QuickFormTotalCard from './QuickFormTotalCard.js';
import QuickFormMultiplePOD from './QuickFormMultiplePOD.js';
...
function QuickFormContainer(props) {
    ...
    var portCodeIndex = props.portCodeIndex
    var countForBlock = 0
    const [onChangeContainerTypeCharges, setOnChangeContainerTypeCharges] = useState([])
    const [onChangeContainerTypeChargesVoyage, setOnChangeContainerTypeChargesVoyage] = useState([])
    ...
    function HighLightField() {
        ...
        $("#" + formNameLowerCase + "-pollocationcode").find(".select__control").addClass("HighLight")
        $("#" + formNameLowerCase + "-polportterm").find(".select__control").addClass("HighLight")
        $("#dynamicmodel-polportterm").find(".select__control").addClass("HighLight")
        ...
        $("#" + formNameLowerCase + "-podlocationcode").find(".select__control").addClass("HighLight")
        $("#" + formNameLowerCase + "-podportterm").find(".select__control").addClass("HighLight")
        $("#dynamicmodel-podportterm").find(".select__control").addClass("HighLight")
        $("#" + formNameLowerCase + "-currency").find(".select__control").addClass("HighLight")
        $("#CompanyROC-Voyage-Quickform").addClass("HighLight")
        $(".ShipOpROC").addClass("HighLight")
        $(".ShipOpBranchCode").addClass("HighLight")
        $(".ContainerCharges").find(".Container_Type").find(".select__control").addClass("HighLight")
        $(".ContainerCharges").find(".BoxOwnership").find(".select__control").addClass("HighLight")
        $(".ContainerCharges").find(".Box_OpCompany").find(".select__control").addClass("HighLight")
        $(".ContainerCharges").find(".BoxOpBranch").find(".select__control").addClass("HighLight")
        $(".ContainerCharges").find(".ParentQty").addClass("HighLight")
        $(".ContainerCharges").find(".UN_Number").find(".select__control").addClass("HighLight")
    ...
    function getMultiplePODIndex(string) {
    ...
    if (props.transferPartial) {
        var ContainerColumn = [
            { columnName: "Container Type", inputType: "single-select", defaultChecked: true, name: "ContainerType", fieldClass: "ContainerType Container_Type onChangeContainerType liveData RequiredFieldAddClass Live_ContainerType readOnlySelect", options: props.containerType, class: "", onChange: getContainerCodeByContainerType, requiredField: true },
            { columnName: "Ownership Type", inputType: "single-select", defaultChecked: true, name: "BoxOwnership", fieldClass: "BoxOwnership onChangeOwnership RequiredFieldAddClass readOnlySelect", options: OwnershipType, class: "", onChange: getCOCCompany, requiredField: true },
            { columnName: "QTY", inputType: "number-withModal", defaultChecked: true, name: "Qty", fieldClass: "Qty cal ParentQty isOverflow", defaultValue: 1, min: "0", class: "", onBlur: onBlurQuantity, readOnly: true },
            { columnName: "Empty", inputType: "checkbox", defaultChecked: true, defaultValue: "0", name: "Empty", fieldClass: "Empty", class: "", onChange: "", disabled: true },
            { columnName: "Box Op Code", inputType: "single-asyncSelect", defaultChecked: false, name: "BoxOperator", fieldClass: "BoxOpCo Box_OpCompany remoteBoxOperatorCompany readOnlySelect onChangeBoxOperator", class: "d-none", onChange: getBoxOperatorBranchByBoxOperatorCompany, loadOption: loadCompanyOptions, optionLabel: "CompanyName", optionValue: "CompanyUUID" },
            ...
            { columnName: "Length", inputType: "input", defaultChecked: true, name: "Length", fieldClass: "cal Length inputDecimalId inputDecimalThreePlaces decimalDynamicForm", class: "", onChange: "", readOnly: true },
            { columnName: "Width", inputType: "input", defaultChecked: true, name: "Width", fieldClass: "cal Width inputDecimalId inputDecimalThreePlaces decimalDynamicForm", class: "", onChange: "", readOnly: true },
            { columnName: "Height", inputType: "input", defaultChecked: true, name: "Height", fieldClass: "cal Height inputDecimalId inputDecimalThreePlaces decimalDynamicForm", class: "", onChange: "", readOnly: true },
            { columnName: "Tues", inputType: "number", defaultChecked: true, name: "Tues", fieldClass: "cal Tues decimalDynamicForm", class: "", onChange: "", readOnly: true },
            ...
            { columnName: "HS Code", inputType: "single-asyncSelect", defaultChecked: false, name: "HSCode", fieldClass: "HS_Code readOnlySelect", class: "d-none", onChange: onChangeHSCode, loadOption: loadHSCodeOptions, optionLabel: "Heading", optionValue: "HSCodeUUID" },
            ...
            { columnName: "Mark", inputType: "input", defaultChecked: false, name: "Mark", fieldClass: "MarkReadonly", class: "d-none", modelClass: "TextMarks", readOnly: true },
            { columnName: "Goods Description", inputType: "input", defaultChecked: false, name: "GoodsDescription", fieldClass: "GoodDescriptionReadonly", class: "d-none", modelClass: "TextGoods", readOnly: true },
        ...
        var ContainerColumn = [
            { columnName: "Container Type", inputType: "single-select", defaultChecked: true, name: "ContainerType", fieldClass: "ContainerType Container_Type onChangeContainerType liveData RequiredFieldAddClass Live_ContainerType", options: props.containerType, class: "", onChange: getContainerCodeByContainerType, requiredField: props.barge ? false : true },
            { columnName: "Ownership Type", inputType: "single-select", defaultChecked: true, name: "BoxOwnership", fieldClass: "BoxOwnership onChangeOwnership RequiredFieldAddClass", options: OwnershipType, class: "", onChange: getCOCCompany, requiredField: props.barge ? false : true },
            { columnName: "QTY", inputType: "number-withModal", defaultChecked: true, name: "Qty", fieldClass: "Qty cal ParentQty isOverflow", defaultValue: 1, min: "0", class: "", onBlur: onBlurQuantity },
            { columnName: "Empty", inputType: "checkbox", defaultChecked: true, defaultValue: "0", name: "Empty", fieldClass: "Empty", class: "", onChange: "" },
            { columnName: "Box Op Code", inputType: "single-asyncSelect", defaultChecked: false, name: "BoxOperator", fieldClass: "BoxOpCo Box_OpCompany remoteBoxOperatorCompany onChangeBoxOperator", class: "d-none", onChange: getBoxOperatorBranchByBoxOperatorCompany, loadOption: loadCompanyOptions, optionLabel: "CompanyName", optionValue: "CompanyUUID" },
            { columnName: "Box Op Co", inputType: "input", defaultChecked: true, name: "BoxOperatorName", fieldClass: "BoxOPCoLoad OriReadOnlyClass", class: "", onChange: "", readOnly: true },
            ...
            { columnName: "HS Code", inputType: "single-asyncSelect", defaultChecked: false, name: "HSCode", fieldClass: "HS_Code", class: "d-none", onChange: onChangeHSCode, loadOption: loadHSCodeOptions, optionLabel: "Heading", optionValue: "HSCodeUUID" },
    ...
    if (formName == "Quotation") {
        defaultValueObject = { QuotationHasContainerType: [{ "Name": `${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`, "Qty": 1, "ContainerItem": ContainerColumn, ContainerTypeOptions: props.containerType }] }
    } else if (formName == "BookingReservation") {
        defaultValueObject = { BookingReservationHasContainerType: [{ "Name": `${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`, "Qty": 1, "ContainerItem": ContainerColumn, ContainerTypeOptions: props.containerType }] }
    } else if (formName == "SalesInvoice") {
        defaultValueObject = { SalesInvoiceHasContainerType: [{ "Name": `${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`, "Qty": 1, "ContainerItem": ContainerColumn, ContainerTypeOptions: props.containerType }] }
    }
    else {
        defaultValueObject = { BookingConfirmationHasContainerType: [{ "Name": `${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`, "Qty": 1, "ContainerItem": ContainerColumn, ContainerTypeOptions: props.containerType }] }
    }
    ...
    const {
        ...
        control,
        name: `${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`
    });

    //set Default for First Came in
    // useEffect(() => {
    //   setValue(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][0]["ContainerTypeOptions"]`,props.containerType)
    //   update(fields)
    // }, [props])

    function appendContainerHandle() {
        append({ "Name": `${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`, "Qty": 1, "ContainerItem": ContainerColumn, ContainerTypeOptions: props.containerType })
            ...
            if (element.name.includes("ContainerCode")) {
                ...
                $.each(regexForContainer, function (key2, value2) {
                    if (value2.regex.test(element.name)) {
                        const label = $(`input[name='${element.name}']`).parent().find(".select__single-value").text();
                        var option = [];
                        var frontName = element.name.slice(0, element.name.indexOf("[") + 3)
                        if ($(element).val()) {
                ...
                $.each(regexForCharges, function (key2, value2) {
                    if (value2.regex.test(element.name)) {
                        ...
                        const newName = element.name.replace(value2.label.charAt(0).toUpperCase() + value2.label.slice(1), value2.label)
        ...
        $.each(tableData, function (key, value) {
            ...
            if (chargeIndex) {
                if (!arrayContainer[containerIndex][containerKey][chargeIndex]) {
                    arrayContainer[containerIndex][containerKey][chargeIndex] = { NestedCharges: [] }
                }
            }

            if (chargeKey == "NestedCharges") {
                const keyToUse = nestedChargeKey
                arrayContainer[containerIndex][containerKey][chargeIndex][chargeKey][nestedChargeIndex] = {
                    ...arrayContainer[containerIndex][containerKey][chargeIndex][chargeKey][nestedChargeIndex],
                    [keyToUse]: value,
                }
            }
            else if (containerKey == `${formName}Charges` || containerKey == `${formName}HasCharges`) {
    ...
    function handleCheckContainerType(e) {
        if ($(e.target).prop("checked")) {
            $(e.target).closest(".container-itemTR").next().find(".checkboxCharges").prop("checked", true)
        }
        else {
            $(e.target).closest(".container-itemTR").next().find(".checkboxCharges").prop("checked", false)
        }
    ...
    function handleSelectAll(e) {
        if ($(e.target).prop("checked")) {
            $(e.target).parent().find(".commontable").find(".checkboxContainerType").prop("checked", true)
            $(e.target).parent().find(".commontable").find(".checkboxCharges").prop("checked", true)
        }
        else {
            $(e.target).parent().find(".commontable").find(".checkboxContainerType").prop("checked", false)
            $(e.target).parent().find(".commontable").find(".checkboxCharges").prop("checked", false)
        }
    }
    ...
    $(".columnChooserColumn").on("change", function (event) {
        ...
        if (props.transferPartial) {
            createCookie(`${formNameLowerCase}transferpartialcontainercolumn`, json_str, 3650);
        } else {
            createCookie(`${formNameLowerCase}containercolumn`, json_str, 3650);
        }
        if (fields.length > 0) {
            if (fields[0].Name == `${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`) {
    ...
    function loadTariff() {
        ...
        ControlOverlay(true)
        var voyageUUID = $(".transhipment-items").length <= 0 ? $("input[name='DynamicModel[VoyageNum]']").val() : $(`input[name="${formName}HasTranshipment[0][FromVoyageNum]"]`).val()
        var filters = {
            SingleLoadTariff: 0,
            ...
            ShipOpBranch: $(`input[name='${formName}[ShipOperatorBranchCode]']`).val(),
            Empty: valueEmpty,
            ...
            if (data.data != null) {
                if (data.data.length != 0) {
                    ...
                    if (PendingCharges.length > 0) {
                        alert(PendingCharges.toString(',') + " is not verified. Please check the charges you loaded.")
                    }
                    setLoadTariffState(data.data)
                } else {
                    alert("No matching tariff found, please check your conditional fields again");
                    HighLightField();
    ...
    function singleLoadTariff(e) {
        ...
        var valueContainerType = targetrow.find(".ContainerType").children().last().val();
    ...
    function getContainerCodeByContainerType(val, index, portCodeIndex) {
        setContainerChangeIndex(index)
        $(`input[name='${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][ContainerType]']`).parent().trigger("change")
        ...
        if (val) {
            ...
            if ($(".TranshipmentCardRow").length > 0) {
                VoyageUUID = $(`input[name='${formName}HasTranshipment[0][FromVoyageNum]']`).val() == undefined ? "" : $(`input[name='${formName}HasTranshipment[0][FromVoyageNum]']`).val()
            } else {

                VoyageUUID = $(`input[name='${formName}[VoyageNum]']`).val() == undefined ? "" : $(`input[name='${formName}[VoyageNum]']`).val()
            }
            getChargesByContainerTypeAndPortCode(ContainerType, UserPortCode, globalContext, VoyageUUID).then(data => {
                try {
                    $.each(data.data, function (key, value) {
                        var PortCode = "";
                        var Float = "";
                        ...
                        if (value.VerificationStatus == "Approved") {
                            ...
                            arrayCharges.push({ value: value.ChargesUUID, label: value.ChargesCode + PortCode + Float })
                        }
                    })
                }
                catch (err) {
            ...
            getContainerTypeById(val.value, globalContext).then(data => {
                setValue(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][Length]`, data.data.Length)
                setValue(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][Width]`, data.data.Width)
                setValue(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][Height]`, data.data.Height)
                setValue(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][Tues]`, data.data.Tues)
            })
    ...
    function getContainerCodeByContainerTypeChangeVoyage() {
        ...
        //$(`input[name='${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${index}][ContainerType]']`).parent().trigger("change")
        if (!props.transferPartial) {
            if (fields.length > 0) {
                var bigArrayCharges = []
                ...
                $.each(fields, function (key, value) {
                    ...
                    getChargesByContainerTypeAndPortCode($(`input[name='${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${key}][ContainerType]']`).val(), UserPortCode, globalContext, VoyageUUID, false).then(data => {
    ...
    function getCOCCompany(val, index, portCodeIndex) {
        $(`input[name='${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][BoxOwnership]']`).parent().trigger("change")
        setGetErrorsFieldsUpdate(val)
    }
    ...
    //                                     setValue(`${formName}POD[${podIndex}][${formName}HasContainerType][${index}][ContainerItem][${key2}][optionColumn]`, Box_OpCompany)
    //                                     update(fields)
    //                                 }
    //                                 if (value2.columnName == "Box Op Branch Code") {
    //                                     setValue(`${formName}POD[${podIndex}][${formName}HasContainerType][${index}][ContainerItem][${key2}][optionColumn]`, sortArray(BoxOperatorBranch))
    //                                     update(fields)
    //                                 }
    //                             })

    //                             setValue(`${formName}POD[${podIndex}][${formName}HasContainerType][${index}][BoxOperatorName]`, BoxOperatorName)
    //                             setValue(`${formName}POD[${podIndex}][${formName}HasContainerType][${index}][BoxOperatorBranch]`, defaultBoxOperatorBranch)
    //                             setValue(`${formName}POD[${podIndex}][${formName}HasContainerType][${index}][BoxOperatorBranchName]`, defaultBoxOperatorBranchName)
    //                             update(fields)
    //                         }
    //                     })
    //                 })
    ...
    //             var filters = {
    //                 "OwnershipType": value,
    //                 "Container.ContainerType": getValues(`${formName}POD[${podIndex}][${formName}HasContainerType][${index}][ContainerType]`),
    ...
    //                 }
    //                 setValue(`${formName}POD[${podIndex}][${formName}HasContainerType][${index}]["ContainerOptions"]`, sortArray(optionContainerList))
    //                 update(fields)
    //             })
    //         } else {
    //             $.each(fields[index]["ContainerItem"], function (key2, value2) {
    //                 if (value2.columnName == "Box Op Code") {
    //                     setValue(`${formName}POD[${podIndex}][${formName}HasContainerType][${index}][ContainerItem][${key2}][optionColumn]`, [])
    //                     update(fields)
    //                 }
    //                 if (value2.columnName == "Box Op Branch Code") {
    //                     setValue(`${formName}POD[${podIndex}][${formName}HasContainerType][${index}][ContainerItem][${key2}][optionColumn]`, [])
    ...
    //                 }
    //             })
    //             setValue(`${formName}POD[${podIndex}][${formName}HasContainerType][${index}][BoxOperatorName]`, "")
    //             setValue(`${formName}POD[${podIndex}][${formName}HasContainerType][${index}][BoxOperatorBranch]`, "")
    //             setValue(`${formName}POD[${podIndex}][${formName}HasContainerType][${index}][BoxOperatorBranchName]`, "")
    //         }
    //     }, 100);
    // })
    ...
    $(".ChargesDisplay").unbind().on("click", function () {
        ...
        if (props.ContainerItem.formName == "BookingReservation") {
            if (props.barge) {
                ...
                if (props.userRule ? props.userRule.find((item) => item == `view-charges-booking-reservation-barge`) !== undefined : "") {
                    ...
                    alert('You are not allowed to View Charges, Please check your User Permission.')
                }
            } else {
                if (props.userRule ? props.userRule.find((item) => item == `view-charges-booking-reservation`) !== undefined : "") {
                    if ($(this).closest("tr").next().hasClass("d-none")) {
                        icon.addClass("fa fa-minus").removeClass("fas fa-plus");
                        $(this).closest("tr").next().removeClass('d-none');
                    }
    ...
    $(".cal").unbind().on("change", function (e) {
        setTimeout(() => {
            var TotalM3 = 0;
    ...
    function getBoxOperatorBranchByBoxOperatorCompany(val, index, portCodeIndex) {
        console.log('here')
        console.log(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][BoxOperator]`)

        $(`input[name='${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][BoxOperator]']`).parent().trigger("change")
    }

    function onBlurQuantity(val, index, portCodeIndex) {
        setQuantity({ val, index, portCodeIndex })
    }

    function onChangeUNNumber(val, index, portCodeIndex) {
        var data = getValues(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}]`)
        $.each(data["ContainerItem"], function (key2, value2) {
            if (value2.columnName == "UN Number") {
                setValue(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][ContainerItem][${key2}][optionColumn]`, val)
                update(fields)
            }
        })
        if (val) {
            ...
            getUNNumberByID(UNNumber, globalContext).then(data => {
                setValue(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][DGClass]`, data.data.Class)
            })
        } else {
            setValue(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][DGClass]`, "")
        }
    }

    function onChangeHSCode(val, index, portCodeIndex) {
        var data = getValues(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}]`)
        $.each(data["ContainerItem"], function (key2, value2) {
        ...
        if (val) {
            ...
            getHSCodeByID(HSCode, globalContext).then(data => {
                setValue(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][Commodity]`, data.data.Description)
            })
        } else {
            setValue(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][Commodity]`, "")

        }
    }

    function getBoxOperatorBranchName(val, index, portCodeIndex) {
        if (val) {
            GetBranchData(val.value, globalContext).then(data => {
                setValue(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][BoxOperatorBranchName]`, data.data.BranchName)
            })
        } else {
            setValue(`${formName}POD[${portCodeIndex}][${formName}HasContainerType][${index}][BoxOperatorBranchName]`, "")
        }
    }
    ...
    useEffect(() => {
        setValue(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${totalDiscount.containerIndex}][TotalDiscount]`, totalDiscount.TotalDiscountTwoDecimal)
        setValue(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${totalTax.containerIndex}][TotalTax]`, totalTax.TotalTaxTwoDecimal)
        setValue(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${totalAmount.containerIndex}][Total]`, totalAmount.TotalAmountTwoDecimal)
    ...
    useEffect(() => {
        if (updateContainerFillData.length > 0) {
            ...
            $.each(updateContainerFillData, function (key, value) {
                value["Name"] = `${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`;
                ...
                if (formName == "SalesInvoice") {
                    if (combinedChargesOptions.length >= key) {
                        $.each(value[`Select${formName}HasCharges`], function (key, value2) {
                            if (value2.PortCode) {
                                arr.push({ value: value2.ChargesUUID, label: value2.ChargesCode + "(" + value2.portCode.PortCode + ")" })
                            }
                            else {
                                arr.push({ value: value2.ChargesUUID, label: value2.ChargesCode })
                            }
                        })
                ...
                $.each(value.ContainerItem, function (key2, value2) {
                    if (value2.columnName == "Box Op Code") {
                        value.ContainerItem[key2].optionColumn = value.BoxOperator ? [{ CompanyUUID: value.BoxOperator, CompanyName: value.boxOperator.CompanyName + "(" + value.boxOperator.ROC + ")" }] : []
                    }
                    if (value2.columnName == "Box Op Branch Code") {
                        if (value.BoxOperatorBranch) {
                            if (value.boxOperatorBranch.portCode) {
                                value.ContainerItem[key2].options = value.BoxOperatorBranch ? [{ value: value.BoxOperatorBranch, label: value.boxOperatorBranch.BranchCode + "(" + value.boxOperatorBranch.portCode.PortCode + ")" }] : []
                            } else {
                                value.ContainerItem[key2].options = value.BoxOperatorBranch ? [{ value: value.BoxOperatorBranch, label: value.boxOperatorBranch.BranchCode }] : []
                            }
                        }
                    }
                    if (value2.columnName == "UN Number") {
                        value.ContainerItem[key2].optionColumn = value.UNNumber ? [{ UNNumberUUID: value.UNNumber, UNNumber: value.uNNumber.UNNumber }] : []
                    }
                    ...
                    if (value2.columnName == "HS Code") {
                        value.ContainerItem[key2].optionColumn = value.HSCode ? [{ HSCodeUUID: value.HSCode, Heading: value.hSCode.Heading }] : []
                    }
                    if (value2.columnName == "Empty") {
                        if (value.Empty == "1") {
                ...
                if (value.ContainerCode) {
                    ...
                    $.each(value.ContainerCode, function (key, value) {
                        arrayContainerCode.push({ value: value.ContainerUUID, label: value.ContainerCode })
                    })
                ...
                if (value[`${formName}HasContainer`]) {
                    ...
                    $.each(value[`${formName}HasContainer`], function (key, value) {
                        arrayContainerCode.push({ value: value.ContainerCode, label: value.ContainerCode })
                ...
                setTimeout(() => { // after append
                    if (value.Empty == 1) {
                        $(`input[name='${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${key}][Empty]']`).prev().prop("checked", true)
                    }
                    setValue(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${key}][ContainerCode][]`, selectedContainer)

                    if (props.userRule) {
                        var viewChargesAccess = props.userRule.find((item) => item == `view-charges-booking-reservation`) !== undefined
                    }

                    $(`input[name='${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${key}][${formName}HasContainerTypeUUID]']`).closest("tr").find(".MarkReadonly").val(value.Mark)
                    $(`input[name='${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${key}][${formName}HasContainerTypeUUID]']`).closest("tr").find(".GoodDescriptionReadonly").val(value.GoodsDescription)
                    if (formName != "SalesInvoice") {
                        if (value[`${formName}Charges`].length > 0) {
                            if (formName == "BookingReservation") {
                                if (viewChargesAccess) {
                                    var charges = $(`input[name='${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${key}][${formName}HasContainerTypeUUID]']`).closest(".container-itemTR").next()
                                    var Icon = $(`input[name='${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${key}][${formName}HasContainerTypeUUID]']`).closest(".container-itemTR").find(".ChargesDisplay").children()[0]
                ...
                if (formName == "Quotation" || formName == "SalesInvoice") {
                    if (formContext.formState.formType == "Update" && !props.transferPartial) {
        ...
        if (removeStateRerender.length > 0) {
            if (!props.barge) {
                ...
                $.each(removeStateRerender, function (key, value) {
                    ...
                    $.each(value.ContainerItem, function (key2, value2) {
                        if (value2.columnName == "Box Op Code") {
                            value.ContainerItem[key2].optionColumn = value.BoxOperator ? [{ CompanyUUID: value.BoxOperator, CompanyName: value["boxOperator"][0]["label"] }] : []
                        }
                        if (value2.columnName == "Box Op Branch Code") {
                            value.ContainerItem[key2].options = value.BoxOperatorBranch ? [{ value: value.BoxOperatorBranch, label: value["boxOperatorBranch"][0]["label"] }] : []
                        }
                        if (value2.columnName == "UN Number") {
                            value.ContainerItem[key2].optionColumn = value.UNNumber ? [{ UNNumberUUID: value.UNNumber, UNNumber: value["uNNumber"][0]["label"] }] : []
                        }
                        if (value2.columnName == "Empty") {
                            if (value.Empty == 1) {
                                value.ContainerItem[key2].defaultValue = 1
                        ...
                        if (value2.columnName == "HS Code") {
                            value.ContainerItem[key2].optionColumn = value.HSCode ? [{ HSCodeUUID: value.HSCode, Heading: value["hSCode"][0]["label"] }] : []
                        }
                        if (value2.columnName == "Empty") {
                            if (value.Empty == "1") {
                                value.ContainerItem[key2].check = true
    ...
    useEffect(() => {
        ...
        $(".onChangeOwnership").on("change", function (e) {
            var closestPortCodeIndex=getMultiplePODIndex($(this).find("input:hidden").attr("name"))
            if(props.portCodeIndex==closestPortCodeIndex){
                setTimeout(() => {
        ...
        $(".onChangeBoxOperator").on("change", function () {
            var closestPortCodeIndex=getMultiplePODIndex($(this).find("input:hidden").attr("name"))
            if(props.portCodeIndex==closestPortCodeIndex){
            setTimeout(() => {
                console.log('here')
        ...
        $(".onChangeContainerType").on("change", function (e) {
            var closestPortCodeIndex=getMultiplePODIndex($(this).find("input:hidden").attr("name"))
            if(props.portCodeIndex==closestPortCodeIndex){
            setTimeout(() => {
                var Findtrindex = $(this).closest("tr").index()
                ...
                if (label.includes("RF")) {
                    $(`input[name='${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${index}][Temperature]']`).attr('readonly', false);
                    $.each(fields[index]["ContainerItem"], function (key2, value2) {
                        if (value2.name == "Temperature") {
                            setValue(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${index}][ContainerItem][${key2}][requiredField]`, true)
                            update(fields)
                        }
                    })
                } else {
                    $(`input[name='${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${index}][Temperature]']`).val("")
                    $(`input[name='${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${index}][Temperature]']`).attr('readonly', true);
                    $.each(fields[index]["ContainerItem"], function (key2, value2) {
                        if (value2.name == "Temperature") {
                            setValue(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${index}][ContainerItem][${key2}][requiredField]`, false)
                            update(fields)
                        }
                    })
                }
                var optionContainerList = []
                var filters = {
                    "OwnershipType": getValues(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${index}][OwnershipType]`),
                ...
                getContainers(value, filters, globalContext).then(data => {
                    ...
                    setValue(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${index}]["ContainerOptions"]`, sortArray(optionContainerList))
                    update(fields)
                })
            }, 100);
        }
    ...
    return (
        <>
                        ...
                        {/* 
                               <div className="card">
                                  <div className="card-body">
                                    ...
                                    <QuickFormMultiplePOD props={props}/>
                                 

                                  </div>

                               </div> */}
                        <div className={`btn-group float-left mb-2 ${props.barge ? "d-none" : ""}`} id="columnchooserdropdown">
                                ...
                                {ContainerColumn.map((item, index) => {
                                    return (
                                        <label key={index} className="dropdown-item dropdown-item-marker">
                                            {item.defaultChecked ? <input type="checkbox" className="columnChooserColumn keep-enabled" defaultChecked /> : <input type="checkbox" className="columnChooserColumn keep-enabled" />}
                                            {item.columnName}
                                        </label>
                                    )
                                })}
                        ...
                        <div className="table_wrap">
                            <div className="table_wrap_inner">
                                ...
                                {props.transferPartial &&
                                    <>
                                        <input type="checkbox" id="selectAll" className="mt-3 keep-enabled" onClick={handleSelectAll}></input>
                                        <label htmlFor="selectAll" className="mt-2">Select All</label>
                                    </>
                                }
                                <div className="row">
                                    {/* {/* {formName === "Quotation" &&
                                                <div>
                                                    <button id="mainLoadTariff" type="button" className="btn btn-success btn-xs mb-2 ml-2" onClick={loadTariff}>
                                                        Load Tariff
                                                    </button>
                                                </div>
                                            } */}
                                    {/* {!props.transferPartial &&
                                                <div>
                                                    <button id="clearTableData" type="button" className="btn btn-success btn-xs mb-2 ml-2" onClick={resetHandle}>
                                                        Clear
                                                    </button>
                                                </div>
                                ...
                                <table className="table table-bordered commontable ContainerTable" style={{ width: "100%" }} ref={ContainerRef}>
                                    ...
                                    <tbody className="ContainerType container-item">
                                        {fields.map((item, index) => {
                                            ...
                                            return (
                                                <>
                                                    <tr key={item ? item.id : ""} className={`container-itemTR ${props.barge ? "d-none" : ""} ${formName == "BookingReservation" ? "container-itemTRForQT" : ""}`} >
                                                        {
                                                                ...
                                                                item.ContainerItem.map((item2, index2) => {
                                                                    if (item2.inputType == "input") {
                                                                        return (
                                                                            <td className={item2.class}>
                                                                                {item2.requiredField ?
                                                                                    <input defaultValue='' readOnly={item2.readOnly ? item2.readOnly : false} {...register(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[' + item2.name + ']', { required: "required" })} className={`form-control ${item2.fieldClass ? item2.fieldClass : ""} ${errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`] ? errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`][`${index}`] ? errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`][`${index}`][`${item2.name}`] ? "has-error" : "" : "" : ""}`} />
                                                                                    :
                                                                                    <input defaultValue='' readOnly={item2.readOnly ? item2.readOnly : false} {...register(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[' + item2.name + ']')} className={`form-control ${item2.fieldClass ? item2.fieldClass : ""}`} />
                                                                                }
                                                                    ...
                                                                    if (item2.inputType == "number") {
                                                                        return (
                                                                            <td className={item2.class}>
                                                                                {item2.requiredField ?
                                                                                    <input type="number" defaultValue='' readOnly={item2.readOnly ? item2.readOnly : false} {...register(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[' + item2.name + ']', { required: "required" })} className={`form-control ${item2.fieldClass ? item2.fieldClass : ""} ${errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`] ? errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`][`${index}`] ? errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`][`${index}`][`${item2.name}`] ? "has-error" : "" : "" : ""}`} />
                                                                                    :
                                                                                    <input type="number" defaultValue='' readOnly={item2.readOnly ? item2.readOnly : false} {...register(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[' + item2.name + ']')} className={`form-control ${item2.fieldClass ? item2.fieldClass : ""}`} />
                                                                                }
                                                                        ...
                                                                        return (
                                                                            <td className={item2.class}>
                                                                                <div className="input-group">
                                                                                    ...
                                                                                    {props.transferPartial &&
                                                                                        <input defaultValue='' readOnly={item2.readOnly ? item2.readOnly : false} {...register(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[ContainerArray]')} className={`form-control containerArrayList d-none ${item2.fieldClass ? item2.fieldClass : ""}`} />
                                                                                    }
                                                                                    {item2.requiredField ?
                                                                                        <input type="number" defaultValue={item2.defaultValue} readOnly={item2.readOnly ? item2.readOnly : false} {...register(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[' + item2.name + ']', { required: "required" })} onBlur={(val) => { val ? item2.onBlur(val, index, props.portCodeIndex) : item2.onBlur(null, index, props.portCodeIndex) }} className={`form-control ${item2.fieldClass ? item2.fieldClass : ""} ${errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`] ? errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`][`${index}`] ? errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`][`${index}`][`${item2.name}`] ? "has-error" : "" : "" : ""}`} />
                                                                                        :
                                                                                        <input type="number" defaultValue={item2.defaultValue} readOnly={item2.readOnly ? item2.readOnly : false} {...register(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[' + item2.name + ']')} onBlur={(val) => { val ? item2.onBlur(val, index, props.portCodeIndex) : item2.onBlur(null, index, props.portCodeIndex) }} className={`form-control ${item2.fieldClass ? item2.fieldClass : ""}`} />
                                                                                    }
                                                                                    <div className="input-group-append" style={{ cursor: "pointer" }} onClick={() => ShareContainerModelMultiplePOD({ formName, index, fields, getValues, setValue, update, globalContext, portCodeIndex })}>
                                                                                        <span className="input-group-text"><i className="fa fa-search" aria-hidden="true"></i></span>
                                                                                    </div>
                                                                                </div>
                                                                                <div className={`SelectContainerCodeField d-none ${props.transferPartial && "ForPartial"}`}>
                                                                                    <Controller
                                                                                        name={(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[ContainerCode][]')}
                                                                                        control={control}
                                                                                        render={({ field: { onChange, value } }) => (
                                                                                            <Select
                                                                                                ...
                                                                                                {...register(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[ContainerCode][]')}
                                                                                                value={value
                                                                                                    ? Array.isArray(value)
                                                                                                        ? value.map((c) =>
                                                                                                            item.ContainerOptions.find((z) => z.value === c)
                                                                                                        )
                                                                    ...
                                                                    if (item2.inputType == "checkbox") {
                                                                        return (
                                                                            <td className={item2.class} style={{ textAlign: "center", verticalAlign: "middle" }}>
                                                                                ...
                                                                                <input type={"hidden"} defaultValue={item2.defaultValue == 1 ? "1" : "0"} className="" {...register(`${formName}POD[${props.portCodeIndex}][${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]]` + '[' + index + ']' + '[' + item2.name + ']')} />
                                                                            </td>
                                                                        )
                                                                    }
                                                                    if (item2.inputType == "single-select") {
                                                                        if (index2 == 0) {
                                                                            ...
                                                                            return (
                                                                                <td className={item2.class}>
                                                                                    <input type="hidden" {...register(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType][${formName}HasContainerTypeUUID]`)} className={`${formName}HasContainerTypeUUID]`} />
                                                                                    <div className="row">

                                                                                        {props.transferPartial &&
                                                                                            <input type="checkbox" className="ml-3 mt-2 checkboxContainerType keep-enabled" onClick={handleCheckContainerType}></input>
                                                                                        ...
                                                                                        {!props.transferPartial &&
                                                                                            <div className="dropdown float-left dropdownbar">
                                                                                                ...
                                                                                                <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                                                    ...
                                                                                                    <button className="dropdown-item loadTariff" type="button" onClick={singleLoadTariff}>Load
                                                                                                        Tariff</button>
                                                                                        ...
                                                                                        <div className="col-md-8" style={{ paddingLeft: "0px", paddingRight: "0px" }}>
                                                                                            {item2.requiredField ?
                                                                                                <Controller
                                                                                                    name={(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[' + item2.name + ']')}
                                                                                                    control={control}
                                                                                                    render={({ field: { onChange, value } }) => (
                                                                                                        <Select

                                                                                                            isClearable={true}
                                                                                                            {...register(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[' + item2.name + ']', { required: "P cannot be blank." })}
                                                                                                            value={value ? item.ContainerTypeOptions.find(c => c.value === value) : null}
                                                                                                            onChange={val => { val == null ? onChange(null) : onChange(val.value); item2.onChange(val, index, props.portCodeIndex); formName == "BookingReservation" ? formContext.QuotationRequiredFields() : val == null ? onChange(null) : onChange(val.value); }}
                                                                                                            options={item.ContainerTypeOptions}
                                                                                                            isOptionDisabled={(selectedValue) => selectedValue.selected == true}
                                                                                                            menuPortalTarget={document.body}
                                                                                                            className={`basic-single ${item2.fieldClass ? item2.fieldClass : ""}  ${errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`] ? errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`][`${index}`] ? errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`][`${index}`][`${item2.name}`] ? "has-error-select" : "" : "" : ""}`}
                                                                                                            classNamePrefix="select"
                                                                                                            onKeyDown={handleKeydown}
                                                                                                            styles={globalContext.customStyles}
                                                                                                ...
                                                                                                <Controller
                                                                                                    ...
                                                                                                    render={({ field: { onChange, value } }) => (
                                                                                                        <Select
                                                                                                            isClearable={true}
                                                                                                            {...register(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[' + item2.name + ']')}
                                                                                                            value={value ? item.ContainerTypeOptions.find(c => c.value === value) : null}
                                                                                                            onChange={val => { val == null ? onChange(null) : onChange(val.value); item2.onChange(val, index, props.portCodeIndex); formName == "BookingReservation" ? formContext.QuotationRequiredFields() : val == null ? onChange(null) : onChange(val.value); }}
                                                                                                            options={item.ContainerTypeOptions}
                                                                                                            isOptionDisabled={(selectedValue) => selectedValue.selected == true}
                                                                                        ...
                                                                                        <Controller
                                                                                            ...
                                                                                            render={({ field: { onChange, value } }) => (
                                                                                                <Select
                                                                                                    isClearable={true}
                                                                                                    {...register(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[' + item2.name + ']', { required: "P cannot be blank." })}
                                                                                                    value={value ? item2.optionColumn ? item2.optionColumn.find(c => c.value === value) : item2.options.find(c => c.value === value) : null}
                                                                                                    onChange={val => { val == null ? onChange(null) : onChange(val.value); item2.onChange(val, index, props.portCodeIndex); formName == "BookingReservation" ? formContext.QuotationRequiredFields() : val == null ? onChange(null) : onChange(val.value); }}
                                                                                                    options={item2.optionColumn ? item2.optionColumn : item2.options}
                                                                                                    menuPortalTarget={document.body}
                                                                                                    isOptionDisabled={(selectedValue) => selectedValue.selected == true}
                                                                                                    className={`basic-single ${item2.fieldClass ? item2.fieldClass : ""} ${errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`] ? errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`][`${index}`] ? errors[`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]`][`${index}`][`${item2.name}`] ? "has-error-select" : "" : "" : ""}`}
                                                                                                    classNamePrefix="select"
                                                                                        ...
                                                                                        <Controller
                                                                                            ...
                                                                                            render={({ field: { onChange, value } }) => (
                                                                                                <Select
                                                                                                    ...
                                                                                                    {...register(`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[' + item2.name + ']')}
                                                                                                    value={value ? item2.optionColumn ? item2.optionColumn.find(c => c.value === value) : item2.options.find(c => c.value === value) : null}
                                                                                                    onChange={val => { val == null ? onChange(null) : onChange(val.value); item2.onChange(val, index, props.portCodeIndex) }}
                                                                                                    options={item2.optionColumn ? item2.optionColumn : item2.options}
                                                                                                    menuPortalTarget={document.body}
                                                                                                    isOptionDisabled={(selectedValue) => selectedValue.selected == true}
                                                                                                    className={`basic-single ${item2.fieldClass ? item2.fieldClass : ""}`}
                                                                                ...
                                                                                <Controller
                                                                                    ...
                                                                                    render={({ field: { onChange, value } }) => (
                                                                                        <AsyncSelect
                                                                                            ...
                                                                                            onChange={val => { val == null ? onChange(null) : onChange(val.value); item2.onChange && item2.onChange(val, index, props.portCodeIndex) }}
                                                                    ...
                                                                    if (item2.inputType == "input-Modal") {
                                                                        return (
                                                                            <td className={item2.class}>
                                                                                ...
                                                                                <input type="text" className={`form-control ${item2.fieldClass ? item2.fieldClass : ""}`} onClick={openTextAreaModal} style={{ cursor: "pointer" }} readOnly={item2.readOnly ? item2.readOnly : false} />
                                                                                        ...
                                                                                        <div className="modal-content">
                                                                                            ...
                                                                                            <div className="modal-body">
                                                                                                <div className="form-group">
                                                                                                    ...
                                                                                                    <textarea id="" className={`form-control ${item2.modelClass}`} {...register((`${formName}POD[${props.portCodeIndex}][${formName}HasContainerType]` + '[' + index + ']' + '[' + item2.name + ']'))} rows="5" placeholder={`Enter ${item2.columnName}`}></textarea>
                                                    ...
                                                    <tr className={props.barge ? "ChargesTable" : " d-none ChargesTable"}>
                                                        {formName == "SalesInvoice" ?
                                                            <NestedTableChargesINV userRule={props.userRule} barge={props.barge ? true : false} transferPartial={props.transferPartial} formName={formName} containerIndex={index} globalContext={globalContext} openTextAreaModal={openTextAreaModal} onChangeContainerTypeChargesVoyage={onChangeContainerTypeChargesVoyage} onChangeContainerTypeCharges={onChangeContainerTypeCharges} containerChangeIndex={containerChangeIndex} quantity={quantity} combinedChargesOptions={combinedChargesOptions} setCombinedChargesOptions={setCombinedChargesOptions} port={props.port} freightTerm={props.freightTerm} setTotalDiscount={setTotalDiscount} setTotalTax={setTotalTax} setTotalAmount={setTotalAmount} taxCode={props.taxCode} currency={props.currency} cargoType={props.cargoType} loadTariffState={loadTariffState} singleloadTariffState={singleloadTariffState} containerTypeAndChargesData={props.containerTypeAndChargesData} removeState={removeState} chargesDiscriptions={chargesDiscriptions} removeAllReleatedCharges={removeAllReleatedCharges} setRemoveAllReleatedCharges={setRemoveAllReleatedCharges} removeStateRerender={removeStateRerender} setRemoveCharges={setRemoveCharges} />
                                                            :
                                                            <NestedTableChargesMultiplePOD portCodeIndex={props.portCodeIndex} userRule={props.userRule} barge={props.barge ? true : false} transferPartial={props.transferPartial} formName={formName} containerIndex={index} globalContext={globalContext} openTextAreaModal={openTextAreaModal} onChangeContainerTypeChargesVoyage={onChangeContainerTypeChargesVoyage} onChangeContainerTypeCharges={onChangeContainerTypeCharges} containerChangeIndex={containerChangeIndex} quantity={quantity} combinedChargesOptions={combinedChargesOptions} setCombinedChargesOptions={setCombinedChargesOptions} port={props.port} freightTerm={props.freightTerm} setTotalDiscount={setTotalDiscount} setTotalTax={setTotalTax} setTotalAmount={setTotalAmount} taxCode={props.taxCode} currency={props.currency} cargoType={props.cargoType} loadTariffState={loadTariffState} singleloadTariffState={singleloadTariffState} containerTypeAndChargesData={props.containerTypeAndChargesData} removeState={removeState} removeAllReleatedCharges={removeAllReleatedCharges} setRemoveAllReleatedCharges={setRemoveAllReleatedCharges} removeStateRerender={removeStateRerender} setRemoveCharges={setRemoveCharges} />
                                                        }
                                                    </tr>
                                                </>
                                            )
                                ...
                                {!props.transferPartial && !props.barge &&
                                    ...
                                    <button className="btn add-container btn-success btn-xs" type="button" onClick={appendContainerHandle}><i className="fa fa-plus"></i> Add
                                        Container</button>
                                }
            ...
            {!props.transferPartial &&
                <QuickFormTotalCard props={props} totalDiscount={totalDiscount} totalTax={totalTax} totalAmount={totalAmount} documentData={props.documentData} />
            }
