...
function QuickFormContainer(props) {
    ...
    if(props.barge){
        var ContainerColumn= [
            ...
            { columnName: "Cargo Type", inputType: "input", defaultChecked: true, name: "CargoTypeName", fieldClass: "form-control", class: "", onChange: "" ,readOnly: true},
            { columnName: "Cargo Rate", inputType: "input", defaultChecked: true, name: "CargoRate", fieldClass: "form-control inputDecimalTwoPlaces", class: "", onChange: "" }, 
            { columnName: "NetWeight", inputType: "input", defaultChecked: true, name: "NetWeight", fieldClass: "form-control inputDecimalThreePlaces", class: "", onChange: "" },
            { columnName: "Gross Weight", inputType: "input", defaultChecked: true, name: "GrossWeight", fieldClass: "form-control inputDecimalThreePlaces", class: "", onChange: "" },
            { columnName: "M3", inputType: "input", defaultChecked: true, name: "M3", fieldClass: "form-control inputDecimalThreePlaces", class: "", onChange: "" },
        ...
        var ContainerColumn = [
            ...
            { columnName: "Package Type", inputType: "input", defaultChecked: true, name: "PackageType", fieldClass: "PackageType", class: "", onChange: "",maxLength:2 },
    ...
    useEffect(() => {
        if (props.containerData && props.containerData.length>0) {
            var arrayDynamic = []
            remove()
            ...
            $.each(newContainerData, function (key, value) {
                ...
                if (value.CargoType) {
                    value.CargoTypeName=value.cargoType.CargoType
                    value.CargoType=value.cargoType.CargoTypeUUID
                }
    ...
    const { register, handleSubmit, setValue, trigger, getValues, reset, control, watch, formState: { errors } } = useForm({
        mode: "onChange",
        defaultValues: {
           BillOfLadingHasContainer: [{ "Name": `${formName}HasContainer`, "Qty": 1, "ContainerItem": ContainerColumn, ContainerTypeOptions: props.containerType }]
                                                            ...
                                                            {item.ContainerItem.map((item2, index2) => {
                                                                if (item2.inputType == "input") {
                                                                    return (
                                                                        <td className={item2.class}>
                                                                             {item2.name=="CargoTypeName"? <input  defaultValue='' className="d-none" {...register(`${formName}HasContainer` + '[' + index + ']' + '[ChargesCode]')}/>:""}
                                                                             {item2.name=="CargoTypeName"? <input  defaultValue='' className="d-none" {...register(`${formName}HasContainer` + '[' + index + ']' + '[CargoType]')}/>:""}
                                                                            {item2.maxLength ?
                                                                            
                                                                            <input defaultValue='' maxLength={item2.maxLength} readOnly={item2.readOnly ? item2.readOnly : false} {...register(`${formName}HasContainer` + '[' + index + ']' + '[' + item2.name + ']')} className={`form-control ${item2.fieldClass ? item2.fieldClass : ""}`} />
                                                                                :
                                                                ...
                                                                if (item2.inputType == "single-select") {
                                                                        ...
                                                                        return (
                                                                            ...
                                                                            {item2.name=="ContainerCode"? <input  defaultValue='' className="d-none" {...register(`${formName}HasContainer` + '[' + index + ']' + '[BillOfLadingHasContainerUUID]')}/>:""}
                                                                                    ...
                                                                                    <div className="modal-content">
                                                                                        ...
                                                                                        <div className="modal-body">
                                                                                            <div className="form-group">
                                                                                                ...
                                                                                                <textarea id="" className={`form-control ${item2.modelClass}`}  {...register((`${formName}HasContainer` + '[' + index + ']' + '[' + item2.name + ']'))} rows="5" placeholder={`Enter ${item2.columnName}`}></textarea>
