...
function Form(props) {
    ...
    function getFiles(id) {
        if (id) {
            $.ajax({
                url: globalContext.globalHost + globalContext.globalPathLink + "user/load-files?id=" + id,
                type: "POST",
                dataType: "json",
                headers: {
                ...
                success: function (data) {
                    ...
                    if(globalContext.profileImage!==data.data[0].file){
                        globalContext.profileImage= data.data[0].file+"?t="+ Math.random()
                    }
    ...
    const onSubmit = (data, event) => {
        ...
        $("#AccessControlTable").find("[type='checkbox']:checked").each(function () {
            ...
            CreateData(globalContext, props.data.modelLink, formdata).then(res => {
                if (res.data) {
                    if (res.data.message == "Duplicate Username!") {
                        ...
                        navigate("/setting/user-settings/user/update/id=" + res.data.data, { state: { formType: "Update", id: res.data.data } })
                    }
                }
    ...
    useEffect(() => {
        ...
        $("#Grant").on('click', function () {
            $("#AccessControlTable").find("input[type='checkbox']").prop("checked", true)

        })

        $("#Revoke").on('click', function () {
            $("#AccessControlTable").find("input[type='checkbox']").prop("checked", false)
    ...
    useEffect(() => {
        ...
        GetAllDropDown(['UserGroup', 'RuleSet', 'Company', "Area"], globalContext).then(res => {
            var ArrayUserGroup = [];
            var ArrayRuleSet = [];
            var ArrayCompany = [];
            var ArrayBranch = [];
            ...
            $.each(res.UserGroup, function (key, value) {
                ArrayUserGroup.push({ value: value.UserGroupUUID, label: value.UserGroup })
            })
            ...
            $.each(res.Company, function (key, value) {
                ArrayCompany.push({ value: value.CompanyUUID, label: value.CompanyName })
            })
        ...
        if (state) {
               ...
               ControlOverlay(true)
                GetUpdateData(state.id, globalContext, props.data.modelLink).then(res => {
                    if(state.formType == "Clone" && state.type == "Company"){
                        setValue('CompanyContact[Branch]', res.data.data.companyContact.Branch);
                        ...
                        if(res.data.data.userGroup){
                            setValue('User[UserGroup]', res.data.data.userGroup.UserGroupUUID);
                        }
                        handleChange({CompanyUUID:res.data.data.company.CompanyUUID,Branch:res.data.data.companyContact.Branch})
                    }
                ...
                getUserRules(state.id, globalContext, props.data.modelLink).then(res => {
            ...
            GetUpdateData(params.id, globalContext, props.data.modelLink).then(res => {
                ...
                getUserRules(params.id, globalContext, props.data.modelLink).then(res => {
                    if (res.data.Scope == "BRANCH") {
                        $("#Port").parent().removeClass("d-none")
                    }
    ...
    return (
        <form  encType="multipart/form-data">
            ...
            {formState ? formState.formType == "Clone" || formState.formType == "New" ? <CreateButton handleSubmitData={handleSubmitForm} title='User' data={props} /> : formState.profile ? <UpdateButton handleSubmitData={handleSubmitForm} title="User" model="user" selectedId="UserUUIDs" id={formState.id} profile={true} data={props} /> : <UpdateButton handleSubmitData={handleSubmitForm} title="User" model="user" selectedId="UserUUIDs" id={formState.id} data={props} /> : <CreateButton handleSubmitData={handleSubmitForm} title='User' data={props} />}
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xs-12 col-md-4">
                                        <div className="form-group">
                                            <label className={`control-label ${errors.User ? errors.User.username ? "has-error-label" : "" : ""}`}>Username</label>

                                            {state ? state.formType == "Update" ?
                                                <input defaultValue='' {...register("User[username]", { required: "Username cannot be blank." })} className={`form-control ${errors.User ? errors.User.username ? "has-error" : "" : ""}`} readOnly /> :
                                                <input defaultValue='' {...register("User[username]", { required: "Username cannot be blank." })} className={`form-control ${errors.User ? errors.User.username ? "has-error" : "" : ""}`} />

                                                : <input defaultValue='' {...register("User[username]", { required: "Username cannot be blank." })} className={`form-control ${errors.User ? errors.User.username ? "has-error" : "" : ""}`} readOnly />}

                                            <p>{errors.User ? errors.User.username && <span style={{ color: "#A94442" }}>{errors.User.username.message}</span> : ""}</p>
                                    ...
                                    <div className="col-xs-12 col-md-2">
                                        <div className="form-group">
                                            <label className={`control-label ${errors.User ? errors.User.email ? "has-error-label" : "" : ""}`}>Email</label>
                                            {state ? state.formType == "Update" ?
                                                <input defaultValue='' {...register("User[email]", { required: "Email cannot be blank." })} className={`form-control ${errors.User ? errors.User.email ? "has-error" : "" : ""}`} readOnly /> :
                                                <input defaultValue='' {...register("User[email]", { required: "Email cannot be blank." })} className={`form-control ${errors.User ? errors.User.email ? "has-error" : "" : ""}`} />

                                                : <input defaultValue='' {...register("User[email]", { required: "Email cannot be blank." })} className={`form-control ${errors.User ? errors.User.email ? "has-error" : "" : ""}`} readOnly />}
                                            <p>{errors.User ? errors.User.email && <span style={{ color: "#A94442" }}>{errors.User.email.message}</span> : ""}</p>
                                    ...
                                    <div className="col-xs-12 col-md-2">
                                        <div className="form-group">
                                            ...
                                            <input defaultValue='' {...register("User[NRIC]")} className={`form-control`} />
                                        </div>
                                    </div>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <Controller
                                                ...
                                                render={({ field: { onChange, value } }) => (
                                                    <Select
                                                        name="User[UserGroup]"
                                                        value={value ? userGroup.find(c => c.value === value) : null}
                                        ...
                                        <div className="form-group">
                                            ...
                                            <Controller
                                                ...
                                                render={({ field: { onChange, value } }) => (
                                                    <Select
                                                        name="User[RuleSet]"
                                                        value={value ? ruleSet.find(c => c.value === value) : null}
                                                        onChange={val => {val == null ? onChange(null) : onChange(val.value);handleChangeRuleSet()}}
                                                        isClearable={true}
                                                        options={ruleSet}
                                                        className="basic-single"
                                                        classNamePrefix="select"
                                    ...
                                    <div className="col-xs-12 col-md-3">
                                        <div className="form-group">
                                            <label className={`control-label ${errors.CompanyContact ? errors.CompanyContact.Branch ? "has-error-label" : "" : ""}`}>Branch</label>
                                            <Controller
                                                ...
                                                render={({ field: { onChange, value } }) => (
                                                    <Select
                                                        {...register("CompanyContact[Branch]", { required: "Branch cannot be blank." })}
                                                        value={value ? companyBranch.find(c => c.value === value) : null}
                                                        onChange={val => val == null ? onChange(null) : onChange(val.value)}
                                                        isClearable={true}
                                                        options={companyBranch}
                                                        className={`basic-single ${errors.CompanyContact ? errors.CompanyContact.Branch ? "has-error-select" : "" : ""}`}
                                            ...
                                            />
                                            <p>{errors.CompanyContact ? errors.CompanyContact.Branch && <span style={{ color: "#A94442" }}>{errors.CompanyContact.Branch.message}</span> : ""}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-xs-12 col-md-3">
                                        <div className="form-group">
                                            ...
                                            <input defaultValue='' {...register("CompanyContact[Department]")} className={`form-control`} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-xs-12 col-md-3">
                                        <div className="form-group">
                                            ...
                                            <input defaultValue='' {...register("CompanyContact[Position]")} className={`form-control`} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="row">
                                        <div className="col-xs-12 col-md-6">
                                            <div className="form-group">
                                                ...
                                                <input type="file" id="ProfilePicture"  {...register("User[image]")} className={`ProfilePicture`} />
                                            </div>
                                        </div>
                                        {props.data.profile ? "" :
                                            <div className="col-xs-12 col-md-6">
                                                <button type="button" id="AccessControl" class="btn btn-success float-right mt-4" title="Access Control" data-toggle="modal" data-target="#AccessControlModal" >Access Control</button>
                                            </div>}
                                    </div>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="row">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <Controller
                                                        ...
                                                        render={({ field: { onChange, value } }) => (
                                                            <Select
                                                                name="CompanyContact[Title]"
                                                                value={value ? titleOption.find(c => c.value === value) : null}
                                                                onChange={val => val == null ? onChange(null) : onChange(val.value)}
                                                                isClearable={true}
                                                                options={titleOption}
                                                                className="basic-single"
                                            ...
                                            <div className="col-xs-12 col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <input defaultValue='' {...register("CompanyContact[FirstName]")} className={`form-control`} />
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-xs-12 col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <input defaultValue='' {...register("CompanyContact[LastName]")} className={`form-control`} />
                                                </div>
                                            </div>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <Controller
                                                        ...
                                                        render={({ field: { onChange, value } }) => (
                                                            <Select
                                                                name="CompanyContact[Gender]"
                                                                value={value ? genderOption.find(c => c.value === value) : null}
                                                                onChange={val => val == null ? onChange(null) : onChange(val.value)}
                                                                isClearable={true}
                                        ...
                                        <div className="col-xs-12 col-md-4">
                                            <div className="form-group">
                                                ...
                                                <input defaultValue='' {...register("CompanyContact[Tel]")} className={`form-control`} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-xs-12 col-md-1">
                                            <div className="form-group">
                                                ...
                                                <input defaultValue='' {...register("CompanyContact[Ext]")} className={`form-control`} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-xs-12 col-md-3">
                                            <div className="form-group">
                                                ...
                                                <input defaultValue='' {...register("CompanyContact[Fax]")} className={`form-control`} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-xs-12 col-md-4">
                                            <div className="form-group">
                                                ...
                                                <input defaultValue='' {...register("CompanyContact[Email]")} className={`form-control`} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-xs-12 col-md-12">
                                            <div className="form-group">
                                                ...
                                                <input defaultValue='' {...register("CompanyContact[AddressLine1]")} className={`form-control`} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-xs-12 col-md-12">
                                            <div className="form-group">
                                                ...
                                                <input defaultValue='' {...register("CompanyContact[AddressLine2]")} className={`form-control`} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-xs-12 col-md-12">
                                            <div className="form-group">
                                                ...
                                                <input defaultValue='' {...register("CompanyContact[AddressLine3]")} className={`form-control`} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-xs-12 col-md-3">
                                            <div className="form-group">
                                                ...
                                                <input defaultValue='' {...register("CompanyContact[Postcode]")} className={`form-control`} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-xs-12 col-md-3">
                                            <div className="form-group">
                                                ...
                                                <input defaultValue='' {...register("CompanyContact[City]")} className={`form-control`} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-xs-12 col-md-3">
                                            <div className="form-group">
                                                ...
                                                <input defaultValue='' {...register("CompanyContact[Country]")} className={`form-control`} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-xs-12 col-md-3">
                                            <div className="form-group">
                                                ...
                                                <input defaultValue='' {...register("CompanyContact[Coordinates]")} className={`form-control`} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-xs-12 col-md-12">
                                            <div className="form-group">
                                                ...
                                                <input defaultValue='' {...register("CompanyContact[Remark]")} className={`form-control`} />
                                            </div>
                                        </div>
    ...
    <div className="modal fade" id="AccessControlModal" tabIndex="-1" role="dialog" aria-hidden="true">
        <div className="modal-dialog modal-xl" role="document">
            <div className="modal-content">
                ...
                <div className="modal-body">
                    <AccessControl portOption={portAcessControl} data={accessControldata} />

                    <button type="button" className="btn btn-success mr-1" id="Grant">Grant</button>
                    <button type="button" className="btn btn-danger" id="Revoke">Revoke</button>
                </div>
                <div className="modal-footer d-none">
                    <button type="button" className="btn btn-primary mt-2" id="SaveAccessControl" data-dismiss="modal">Save</button>
    ...
    {/* <!-- Modal: User Group Change  --> */}
		<div className="modal fade" id="ChangeRuleSetModal" tabindex="-1" role="dialog" aria-hidden="true">
			<div className="modal-dialog" role="document">
				<div className="modal-content">
					...
					<div className="modal-body">
						<h4>Do you want to replace the same User Rules as this Rule Set?</h4>
					</div>
					<div className="modal-footer">
						<button type="button" className="btn btn-primary mt-2" id="ChangeRuleSet" onClick={handleConfirmRuleSet} data-dismiss="modal">Yes</button>
						<button type="button" className="add btn btn-secondary" id="KeepRuleSet" data-dismiss="modal">No</button>
					</div>
				</div>
			</div>
		</div>
