...
function Form(props) {
    ...
    function getFiles(id) {
        ...
        $.ajax({
            url: globalContext.globalHost + globalContext.globalPathLink + "container/load-files?id=" + id,
            type: "POST",
            dataType: "json",
            headers: {
              ...
              <div class="jFiler-item-container">\
                <div class="jFiler-item-inner">\
                  <div class="jFiler-item-icon pull-left"></div>\
                    ...
                    <div><input type="hidden" name="name[]" value="{{fi-name}}"></div>\
                    <div><input class="caption" name="caption[]"></div>\
                  </div>\
                </div>\
              </div>\
            </li>',
            ...
            CreateData(globalContext, props.data.modelLink, formdata).then(res => {
                if (res.data) {
                    if (res.data.message == "Duplicate Container Code") {
                        ...
                        navigate("/asset/container/update/id=" + res.data.data, { state: { formType: "Update", id: res.data.data } })
                    }
                }
                ...
                $.each(res, function (key, value) {
                    $.each(value.companyBranchHasCompanyTypes, function (key, value2) {
                        if (value2.CompanyType == "----depot") {
                            arrayDepotBranch.push({ value: value.CompanyBranchUUID, label: value.BranchName + "(" + value.portCode.PortCode + ")" })
                    ...
                    if (res.data.length > 0) {
                        $.each(res.data, function (key, value) {
                            if (value.CompanyName == "SHIN YANG SHIPPING SDN BHD") {
                                setValue("DynamicModel[boxopname]", { CompanyUUID: value.CompanyUUID, CompanyName: value.CompanyName })
                                handleChangeBoxOperator({ CompanyName: value.CompanyName, CompanyUUID: value.CompanyUUID })
                            }
                        });
                    }
    ...
    useEffect(() => {
        ...
        GetAllDropDown(['Company', 'CompanyBranch', "ContainerType"], globalContext).then(res => {
        ...
        if (state) {
            if (state.formType == "Update" || state.formType == "Clone") {
                ...
                GetUpdateData(state.id, globalContext, props.data.modelLink).then(res => {
                    ...
                    GetBranchData(res.data.data.BoxOperator, globalContext).then(res => {
                        setValue("DynamicModel[boxopname]", { CompanyUUID: res.data.Company, CompanyName: res.data.company.CompanyName })
                        handleChangeBoxOperator({ CompanyUUID: res.data.Company, CompanyName: res.data.company.CompanyName })
                    })
                    GetBranchData(res.data.data.Depot, globalContext).then(res => {

                        setValue("Container[DepotCompany]", { CompanyUUID: res.data.Company, CompanyName: res.data.company.CompanyName })
                        handleChangeDepotCompany({ CompanyUUID: res.data.Company, CompanyName: res.data.company.CompanyName })
                    })
                    if (res.data.data.Owner) {
                        setValue("Container[Owner]", { CompanyUUID: res.data.data.Owner, CompanyName: res.data.data.owner.CompanyName })
                        handleChangeCompany({ CompanyUUID: res.data.data.Owner, CompanyName: res.data.data.owner.CompanyName })
                    }
    ...
    return (
        <form encType="multipart/form-data">
            {formState ? formState.formType == "Clone" || formState.formType == "New" ? <CreateButton  handleSubmitData={handleSubmitForm} title='Container' data={props} /> : <UpdateButton  handleSubmitData={handleSubmitForm} title="Container" model="container" selectedId="ContainerUUIDs" id={formState.id} data={props} /> : <CreateButton  handleSubmitData={handleSubmitForm} title='Container' data={props} />}
                        ...
                        <div className="row">
                            ...
                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    <label className={`control-label ${errors.Container ? errors.Container.ContainerCode ? "has-error-label" : "" : ""}`}>Container Code</label>

                                    <input defaultValue='' {...register("Container[ContainerCode]", { required: "Container Code cannot be blank." })} className={`form-control ${errors.Container ? errors.Container.ContainerCode ? "has-error" : "" : ""}`} />
                                    <p>{errors.Container ? errors.Container.ContainerCode && <span style={{ color: "#A94442" }}>{errors.Container.ContainerCode.message}</span> : ""}</p>
                                </div>
                            </div>

                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    <label className={`control-label ${errors.Container ? errors.Container.ContainerType ? "has-error-label" : "" : ""}`}>Container Type</label>
                                    <Controller
                                        ...
                                        render={({ field: { onChange, value } }) => (
                                            <Select
                                                isClearable={true}
                                                {...register("Container[ContainerType]", { required: "Container Type cannot be blank." })}
                                                value={value ? containerType.find(c => c.value === value) : null}
                                                onChange={val => { val == null ? onChange(null) : onChange(val.value); handleChangeContainerType(val) }}
                                                options={containerType}
                                                className={`form-control ContainerType ${errors.Container ? errors.Container.ContainerType ? "has-error-select" : "" : ""}`}
                                    ...
                                    />
                                    <p>{errors.Container ? errors.Container.ContainerType && <span style={{ color: "#A94442" }}>{errors.Container.ContainerType.message}</span> : ""}</p>
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    ...
                                    <input defaultValue='' {...register("Container[Length]")} className={`form-control inputDecimalThreePlaces`} />
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    ...
                                    <input defaultValue='' {...register("Container[Width]")} className={`form-control inputDecimalThreePlaces`} />
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    ...
                                    <input defaultValue='' {...register("Container[Height]")} className={`form-control inputDecimalThreePlaces`} />
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    ...
                                    <input defaultValue='' {...register("Container[M3]")} className={`form-control inputDecimalThreePlaces`} />
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    ...
                                    <input defaultValue='' {...register("Container[NetWeight]")} className={`form-control inputDecimalThreePlaces`} />
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    ...
                                    <input defaultValue='' {...register("Container[GrossWeight]")} className={`form-control inputDecimalThreePlaces`} />
                                </div>
                            </div>

                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    <label className="control-label">Container Weight(kg)</label>

                                    <input defaultValue='' {...register("Container[ContainerWeight]")} className={`form-control inputDecimalThreePlaces`} />
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    ...
                                    <input type="number" defaultValue='' {...register("Container[Tues]")} className={`form-control`} />
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    ...
                                    <input type="number" defaultValue='' {...register("Container[YearBuild]")} className={`form-control`} />
                                </div>
                            </div>
                                    ...
                                    <Controller
                                        ...
                                        render={({ field: { onChange, value } }) => (
                                            <Select
                                                ...
                                                value={value ? gradeOption.find(c => c.value === value) : null}
                            ...
                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    <label className={`control-label ${errors.Container ? errors.Container.Status ? "has-error-label" : "" : ""}`}>Status</label>
                                    <Controller
                                        ...
                                        render={({ field: { onChange, value } }) => (
                                            <Select
                                                ...
                                                isClearable={true}
                                                {...register("Container[Status]", { required: "Status cannot be blank." })}
                                                onMenuOpen={() => { handleOpenMenu(statusOption) }}
                                                isOptionDisabled={(selectedValue) => selectedValue.selected == true}
                                                value={value ? statusOption.find(c => c.value === value) : null}
                                                onChange={val => { val == null ? onChange(null) : onChange(val.value) }}
                                                options={statusOption}
                                                className={`form-control Status ${movementStat?"readOnlySelect":""} ${errors.Container ? errors.Container.Status ? "has-error-select" : "" : ""}`}
                                                classNamePrefix="select"
                                                styles={globalContext.customStyles}
                                    ...
                                    />
                                      <p>{errors.Container ? errors.Container.Status && <span style={{ color: "#A94442" }}>{errors.Container.Status.message}</span> : ""}</p>
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-12">
                                <div className="form-group">
                                    ...
                                    <textarea defaultValue='' {...register("Container[Description]")} className={`form-control`} />
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-2">
                                <div className="form-group">
                                    <label className={`control-label ${errors.Container ? errors.Container.OwnershipType ? "has-error-label" : "" : ""}`}>Ownership Type</label>
                                    <Controller
                                        ...
                                        render={({ field: { onChange, value } }) => (
                                            <Select
                                                isClearable={true}
                                                {...register("Container[OwnershipType]", { required: "Container Type cannot be blank." })}
                                                value={value ? ownerTypeOption.find(c => c.value === value) : null}
                                                onChange={val => { val == null ? onChange(null) : onChange(val.value); handleChangeOwner(val) }}
                                                options={ownerTypeOption}
                                                className={`form-control OwnershipType ${errors.Container ? errors.Container.OwnershipType ? "has-error-select" : "" : ""}`}
                                                classNamePrefix="select"
                                                styles={globalContext.customStyles}
                                    ...
                                    />
                                    <p>{errors.Container ? errors.Container.OwnershipType && <span style={{ color: "#A94442" }}>{errors.Container.OwnershipType.message}</span> : ""}</p>
                                </div>
                            </div>

                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    <label className="control-label" >Box Op Name
                                    </label>
                                    <Controller
                                        ...
                                        render={({ field: { onChange, value } }) => (
                                            <AsyncSelect
                                                ...
                                                onChange={e => { e == null ? onChange(null) : onChange({ CompanyUUID: e.CompanyUUID, CompanyName: e.CompanyName }); handleChangeBoxOperator(e) }}
                            ...
                            <div className="col-xs-12 col-md-2">
                                <div className="form-group">
                                    ...
                                    <input defaultValue='' {...register("DynamicModel[BoxOpROC]")} className={`form-control`} readOnly />
                                </div>
                            </div>

                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    <label className="control-label" >Box Op Branch Name
                                    </label>
                                    <Controller
                                        ...
                                        render={({ field: { onChange, value } }) => (
                                            <Select
                                                ...
                                                onChange={val => { val == null ? onChange(null) : onChange(val.value); handleChangeBoxOpBranch(val) }}
                            ...
                            <div className="col-xs-12 col-md-2">
                                <div className="form-group">
                                    ...
                                    <input defaultValue='' {...register("DynamicModel[BoxOpBranch]")} className={`form-control`} readOnly />
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    <label className="control-label" >Owner Company
                                    </label>
                                    <Controller
                                        ...
                                        render={({ field: { onChange, value } }) => (
                                            <AsyncSelect
                                                ...
                                                cacheOptions
                                                placeholder={globalContext.asyncSelectPlaceHolder}
                                                onChange={e => { e == null ? onChange(null) : onChange({ CompanyUUID: e.CompanyUUID, CompanyName: e.CompanyName }); handleChangeCompany(e) }}
                                                getOptionLabel={e => e.CompanyName}
                                                getOptionValue={e => e.CompanyUUID}
                            ...
                            <div className="col-xs-12 col-md-1">
                                <div className="form-group">
                                    ...
                                    <input defaultValue='' {...register("DynamicModel[OwnerROC]")} className={`form-control`} readOnly />
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    ...
                                    <label className={`control-label ${errors.Container ? errors.Container.DepotCompany ? "has-error-label" : "" : ""}`}>Depot Company</label>
                                    <Controller
                                        ...
                                        render={({ field: { onChange, value } }) => (
                                            <AsyncSelect
                                                isClearable={true}
                                                value={value}
                                                {...register("Container[DepotCompany]", { required: "Depot Company cannot be blank." })}
                                                cacheOptions
                                                placeholder={globalContext.asyncSelectPlaceHolder}
                                                onChange={e => { e == null ? onChange(null) : onChange({ CompanyUUID: e.CompanyUUID, CompanyName: e.CompanyName }); handleChangeDepotCompany(e) }}
                                                getOptionLabel={e => e.CompanyName}
                                                getOptionValue={e => e.CompanyUUID}
                                                loadOptions={loadOptionsDepot}
                                                menuPortalTarget={document.body}
                                                className={`form-control DepotCompany ${errors.Container ? errors.Container.DepotCompany ? "has-error-select" : "" : ""}`}
                                                classNamePrefix="select"
                                                styles={globalContext.customStyles}
                                    ...
                                    />
                                    <p>{errors.Container ? errors.Container.DepotCompany && <span style={{ color: "#A94442" }}>{errors.Container.DepotCompany.message}</span> : ""}</p>
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-1">
                                <div className="form-group">
                                    ...
                                    <input defaultValue='' {...register("DynamicModel[DepotROC]")} className={`form-control`} readOnly />
                                </div>
                            </div>

                            <div className="col-xs-12 col-md-3">
                                <div className="form-group">
                                    <label className={`control-label ${errors.Container ? errors.Container.Depot ? "has-error-label" : "" : ""}`}>Depot Branch</label>
                                    <Controller
                                        ...
                                        render={({ field: { onChange, value } }) => (
                                            <Select
                                                isClearable={true}
                                                {...register("Container[Depot]", { required: "Depot Branch cannot be blank." })}
                                                value={value ? depotBranch.find(c => c.value === value) : null}
                                                onChange={val => { val == null ? onChange(null) : onChange(val.value); handleChangeDepotBranch(val) }}
                                                options={depotBranch}
                                                className={`form-control Depot ${errors.Container ? errors.Container.Depot ? "has-error-select" : "" : ""}`}
                                                classNamePrefix="select"
                                                styles={globalContext.customStyles}
                                    ...
                                    />
                                    <p>{errors.Container ? errors.Container.Depot && <span style={{ color: "#A94442" }}>{errors.Container.Depot.message}</span> : ""}</p>
                                </div>
                            </div>
                            ...
                            <div className="col-xs-12 col-md-1">
                                <div className="form-group">
                                    ...
                                    <input defaultValue='' {...register("DynamicModel[BranchROC]")} className={`form-control`} readOnly />
                                </div>
                            </div>
                            ...
                            <div className="card lvl1 col-md-12">
                                <div className="card-body CocCard d-none">
                                    <div className="row">
                                        <div class="col-xs-12 col-md-2">
                                            <div className="form-group">
                                                <label className="control-label">COC Type
                                                </label>
                                                <Controller
                                                    ...
                                                    render={({ field: { onChange, value } }) => (
                                                        <Select
                                                            ...
                                                            value={value ? COCTypeOption.find(c => c.value === value) : null}
                                                            onChange={val => { val == null ? onChange(null) : onChange(val.value); handleCOCType(val) }}
                                        ...
                                        <div className="col-xs-12 col-md-2 cOCHiredContractRow">
                                            <div className="form-group">
                                                <label className="control-label" >COC Hired Contract
                                                </label>
                                                <Controller
                                                    ...
                                                    render={({ field: { onChange, value } }) => (
                                                        <Select
                                                            ...
                                                            value={value ? COCHiredContractOption.find(c => c.value === value) : null}
                                                            onChange={val => { val == null ? onChange(null) : onChange(val.value); }}
                                ...
                                <div class="card-body SocCard d-none">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-2">
                                            <div className="form-group">
                                                <label className="control-label">SOC Type
                                                </label>
                                                <Controller
                                                    ...
                                                    render={({ field: { onChange, value } }) => (
                                                        <Select
                                                            ...
                                                            value={value ? SOCTypeOption.find(c => c.value === value) : null}
                                                            onChange={val => { val == null ? onChange(null) : onChange(val.value) }}
                                        ...
                                        <div className="col-xs-12 col-md-2">
                                            <div className="form-group">
                                                <label className="control-label" >SOC Free Use Detail
                                                </label>
                                                <Controller
                                                    ...
                                                    render={({ field: { onChange, value } }) => (
                                                        <Select
                                                            ...
                                                            value={value ? SOCcFreeUseDetailOption.find(c => c.value === value) : null}
                                                            onChange={val => { val == null ? onChange(null) : onChange(val.value); }}
                            ...
                            <div className="col-xs-12 col-md-12">
                                <div className="form-group">
                                    ...
                                    <input type="file" id="ContainerAttachments" multiple {...register("Container[Attachment][]")} className={`Attachments`} />
                            ...
                            <div className="col-xs-12 col-md-3 mt-2">
                                <div className="form-group mt-4 mb-1">
                                    ...
                                    <input type="text" className="form-control d-none" defaultValue='1' {...register('Container[Valid]')} />
