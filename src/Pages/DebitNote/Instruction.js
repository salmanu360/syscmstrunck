...
function Instruction(props) {
    ...
    var InstructionItem = {
        ...
        formNameBarge:"SalesDebitNoteBarge",
        ...
        if (props.instructionData) {
            ...
            formContext.setStateHandle([{ label: props.instructionData.VoyageName + "(" + props.instructionData.VesselCode + ")", value: props.instructionData.VoyageNum }], "QuickFormVoyageNum")
                ...
                if (props.instructionData.FinalDestinationHandler) {
                    props.setValue("SalesDebitNote[FinalDestinationHandler]", { CompanyUUID: props.instructionData.finalDestinationHandler.CompanyUUID, CompanyName: props.instructionData.finalDestinationHandler.CompanyName })
                }
                ...
                if (props.instructionData.POLHandlingOfficeCode) {
                    ...
                    props.setValue("SalesDebitNote[POLAgentName]", props.instructionData.pOLHandlingOfficeCode.company.CompanyUUID)
                    props.setValue("SalesDebitNote[POLAgentROC]", props.instructionData.pOLHandlingOfficeCode.company.ROC)
                ...
                if (props.instructionData.PODHandlingOfficeCode) {
                    ...
                    props.setValue("SalesDebitNote[PODAgentName]", props.instructionData.pODHandlingOfficeCode.company.CompanyUUID)
                    props.setValue("SalesDebitNote[PODAgentROC]", props.instructionData.pODHandlingOfficeCode.company.ROC)
    ...
    return (
        <div className={`DetailFormDetails Instructions`}>
            <div className="salesdebitnote-instruction-form">
