...
function Branch(props) {
    ...
    return (
			<div>
						...
						<div className='card lvl1 BranchCard' key={item.id}>
							<div className='card-header'>
								...
								<div className='card-tools'>
									<button
										type='button'
										className='remove-branch btn btn-danger btn-xs'
							...
							<div className='card-body'>
											...
											<div className='row'>
													...
													<div className='form-group'>
														<label
															className={`control-label ${
																props.errors.CompanyBranch
																	? props.errors.CompanyBranch[`${index}`]
																		? props.errors.CompanyBranch[`${index}`]
																				.PortCode
																			? "has-error-label"
																			: ""
														...
														<Controller
															...
															render={({field: {onChange, value}}) => (
																<Select
																	...
																	className={`form-control portCode ${
																		props.errors.CompanyBranch
																			? props.errors.CompanyBranch[`${index}`]
																				? props.errors.CompanyBranch[`${index}`]
																						.PortCode
												...
												<div className='card col-md-12'>
													...
													<div className='card-body CompanyTypeCard'>
														<CompanyType
															...
															BranchIndex={index}
															CompanyTypeOptions={props.CompanyTypeOptions}
															BusinessNatureOptions={
																props.BusinessNatureOptions
															}
															CustomerTypeOptions={props.CustomerTypeOptions}
															SupplierTypeOptions={props.SupplierTypeOptions}
															PortCodeOptions={props.PortCodeOptions}
														/>
													</div>
												</div>
												...
												<div className='col-xs-12 col-md-3 mt-2'>
													<div className='form-group mt-4 mb-1'>
														<input
															type='checkbox'
															className='validCheckboxBranch'
															id='validCheckboxBranch'
															defaultChecked
														/>
														<input
															type='text'
															...
															defaultValue='1'
															{...register(
																"CompanyBranch" + "[" + index + "]" + "[Valid]"
															)}
														/>
														<label
															className='control-label ml-2'
															htmlFor='validCheckboxBranch'>
															Valid
														</label>
													</div>
												</div>
								...
								<div className='card col-md-12'>
									...
									<div className='card-body'>
										<BranchContact
											manuallyAdd={manuallyAdd}
											BranchContactData={branchContact}
											BranchIndex={index}
				...
				<button
					type='button'
					className='add-branch btn btn-success btn-xs mb-2 mt-2 ml-2'
					onClick={() => {
						appendBranch();
					}}>
					<span className='fa fa-plus'></span>Add Company Branch
				</button>
			</div>
		);
}
