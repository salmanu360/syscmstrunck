...
import { createCookie, getCookie, GetChargesByAreaContainer, GetChargesById, GetTaxCodeById, initHoverSelectDropownTitle, sortArray } from '../../Components/Helper.js'
            ...
            $.each(newData, function (key, value) {
                if (key == props.containerIndex) {
                    ...
                    $.each(newValue.ContainerCode, function (key2, value2) {
                        ...
                        newValue2.innerContainerItem[0].options = sortArray(arrayOption)
