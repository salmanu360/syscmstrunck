...
function QuickForm(props) {
      ...
      if (props.middleCardData.Attention) {
        if(props.middleCardData.Attention.QuotationBillTo){
          if (props.middleCardData.Attention.QuotationBillTo.CompanyName) {
            props.setValue("DynamicModel[BillToCompany]",props.middleCardData.Attention.QuotationBillTo.CompanyName + "(" + props.middleCardData.Attention.QuotationBillTo.rOC.ROC + ")")
          }
        }
        if(props.middleCardData.Attention.QuotationShipper){
          if (props.middleCardData.Attention.QuotationShipper.CompanyName) {
            $("#CompanyROC-Shipper-Quickform").val(props.middleCardData.Attention.QuotationShipper.CompanyName + "(" + props.middleCardData.Attention.QuotationShipper.rOC.ROC + ")")
          }
        }
        if(props.middleCardData.Attention.QuotationShipOp){
          if (props.middleCardData.Attention.QuotationShipOp.CompanyName) {
            $("#CompanyROC-Voyage-Quickform").val(props.middleCardData.Attention.QuotationShipOp.CompanyName + "(" + props.middleCardData.Attention.QuotationShipOp.ROC + ")")
          }
        }
      }
      props.trigger()
  ...
  var DocumentItem ={
    ...
    cardLength:"col-md-4",
    element : [
      {title:"QT No.", id:"dynamicmodel-docnum", className:"", name:"DynamicModel[DocNum]", dataTarget:"DocNum", gridSize:"col-xs-12 col-md-6", type:"input-text", onChange:"", specialFeature:["readonly"]},
      {title:"QT Effective Date", id:"dynamicmodel-docdate", className:"docDate flatpickr-input", name:"DynamicModel[DocDate]", dataTarget:"DocDate", value:Date, gridSize:"col-xs-12 col-md-6", type:"flatpickr-input", onChange:"", specialFeature:['required']},
      {title:"Sales Person", id:"quotation-salesperson-quickform", className:"sales_person", name:"DynamicModel[SalesPerson]", dataTarget:"SalesPerson", gridSize:"col-xs-12 col-md-6", type:"dropdown", option:props.user, onChange:"", specialFeature:['required']},
      {title:"Quotation Type ", id:"quotation-quotationtype-quickform", className:"quotation_type", name:"DynamicModel[QuotationType]", dataTarget:"QuotationType", gridSize:"col-xs-12 col-md-6", type:"dropdown", option:quotaitonTypeOptions, onChange:props.changeQuotationType, specialFeature:['required']},
      {title:"Validity Days", id:"quotation-validityday-quickform", className:"validityDay", name:"DynamicModel[ValidityDay]", dataTarget:"ValidityDay", gridSize:"col-xs-12 col-md-6 NormalBooking", type:"input-number", defaultValue:"7", onChange:"", specialFeature:['required']},
      {title:"Last Valid Date", id:"quotation-lastvaliddate-quickform", className:"lastValidDate flatpickr-input active", name:"DynamicModel[LastValidDate]", dataTarget:"LastValidDate",value:formContext.lastValidDate, gridSize:"col-xs-12 col-md-6 NormalBooking", type:"flatpickr-input", onChange:"", specialFeature:['required']},
      {title:"Advance Booking Start Date", id:"quotation-advancebookingstartdate-quickform", className:"flatpickr-input docDate active", name:"DynamicModel[AdvanceBookingStartDate]", dataTarget:"AdvanceBookingStartDate",value:Date, gridSize:"col-xs-12 col-md-6 AdvanceBooking", type:"flatpickr-input", onChange:"", specialFeature:["hidden"]},
      {title:"Advance Booking Last Valid Date", id:"quotation-advancebookinglastvaliddate-quickform", className:"flatpickr-input lastValidDate active", name:"DynamicModel[AdvanceBookingLastValidDate]", dataTarget:"AdvanceBookingLastValidDate",value:formContext.lastValidDate, gridSize:"col-xs-12 col-md-6 AdvanceBooking", type:"flatpickr-input", onChange:"", specialFeature:["hidden"]},
    ]
  }
