  ...
  const formContext = useContext(FormContext)
    ...
    useEffect(() => {
			if (props.instructionData) {
				...
				$("#quotation-quickform-detention").val(
					props.instructionData.Detention
				);
				$("#quotation-quickform-demurrage").val(
					props.instructionData.Demurrage
				);
				...
				if (props.instructionData.POLHandlingOfficeCode) {
					formContext.setStateHandle(
						[
							{
								value:
									props.instructionData.pOLHandlingOfficeCodeCompany
										.CompanyUUID,
								label:
									props.instructionData.pOLHandlingOfficeCodeCompany
										.CompanyName,
				...
				if (props.instructionData.PODHandlingOfficeCode) {
					formContext.setStateHandle(
						[
							{
								value:
									props.instructionData.pODHandlingOfficeCodeCompany
										.CompanyUUID,
								label:
									props.instructionData.pODHandlingOfficeCodeCompany
										.CompanyName,
		...
		return (
			<div className={`DetailFormDetails Instructions`}>
				<div className='quotation-instruction-form'>
					<DetailFormInstructionMultiplePOD
