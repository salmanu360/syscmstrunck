...
function QuickForm(props) {
  ...
  function handleTransferFrom(val, index) {
    var modelLinkTemp = "sales-credit-note"
    if (globalContext.userRule !== "") {
      ...
      if (filteredAp.find((item) => item == `transfer-${modelLinkTemp}`) !== undefined) {
        if (val) {
          window.$("#TransferToCreditNoteModal").modal("toggle")
          TransferToCreditNote(val.value, globalContext).then(res => {
  ...
  useEffect(() => {
    console.log(containerTypeAndChargesData)
  ...
  function confirmTransferTo() {
    ...
    $(".checkboxCharges:checked").each(function () {
      ...
      if(props.modelLink == "credit-note-barge"){
      ...
      if (props.modelLink == "credit-note-barge") {
        ...
        console.log(closestContainerArrayList)
  ...
  var DocumentItem = {
    ...
    cardLength: props.modelLink == "credit-note-barge" ? "col-md-4" : "col-md-12",
    element: [
      { title: "CN No.", id: "salescreditnote-docnum", className: "", name: "SalesCreditNote[DocNum]", dataTarget: "DocNum", gridSize: "col-xs-12 col-md-2", type: "input-text", onChange: "", specialFeature: ["readonly"] },
      { title: "CN Doc Date", id: "salescreditnote-docdate", className: "docDate flatpickr-input", name: "SalesCreditNote[DocDate]", dataTarget: "DocDate", value: Date, gridSize: "col-xs-12 col-md-2", type: "flatpickr-input", onChange: "", specialFeature: [] },
      { title: "Sales Person", id: "salescreditnote-salesperson", className: "sales_person", name: "SalesCreditNote[SalesPerson]", dataTarget: "SalesPerson", gridSize: "col-xs-12 col-md-2", type: "dropdown", option: props.user, onChange: "", specialFeature: [] },
      { title: "Currency", id: "salescreditnote-currency", className: "currency", name: "SalesCreditNote[Currency]", defaultValue: formContext.defaultCurrency, dataTarget: "Currency", gridSize: "col-xs-12 col-md-3", type: "dropdown", option: props.currency, onChange: "", specialFeature: [] },
      { title: "Currency Rate", id: "salescreditnote-currencyexchangerate", className: "", name: "SalesCreditNote[CurrencyExchangeRate]", dataTarget: "DocNum", gridSize: "col-xs-12 col-md-3", type: "input-text", onChange: "", specialFeature: [], defaultValue: "1.00" },
      { title: "Document Description", id: "salescreditnote-docdesc", className: "", name: "SalesCreditNote[DocDesc]", dataTarget: "DocNum", gridSize: "col-xs-12 col-md-12", type: "textarea", onChange: "", specialFeature: [] },
  ...
  var ShippingInstructionItem = {
    ...
    element: [
      ...
      { title: "Voyage Num", id: "dynamicmode-voyagenum", className: "voyageNum readOnlySelect bargeRelatedField QuickFormVoyageNum", name: "DynamicModel[VoyageNum]", defaultValue: "", dataTarget: "", gridSize: "col-xs-12 col-md-3", type: "dropdown", option: [], onChange: "", specialFeature: [] },
  ...
  var MiddleCardItem = {
    ...
    element: [
      ...
      { title: "Branch Tel", id: "salescreditnotebillto-quickform-branchtel", className: "branchtelbillto", name: "DynamicModel[BillToBranchTel]", gridSize: "col-xs-12 col-md-3", type: "input-text", onChange: "", specialFeature: [], dataTarget: "BranchTel-BillTo" },
      { title: "Branch Email", id: "salescreditnotebillto-quickform-branchemail", className: "branchemailbillto", name: "DynamicModel[BillToBranchEmail]", gridSize: "col-xs-12 col-md-3", type: "input-text", onChange: "", specialFeature: [], dataTarget: "BranchEmail-BillTo" },
