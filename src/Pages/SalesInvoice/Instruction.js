...
function Instruction(props) {
    ...
    var InstructionItem = {
        ...
        formNameBarge:"SalesInvoiceBarge",
        ...
        if (props.instructionData) {
            ...
            formContext.setStateHandle([{ label: props.instructionData.VoyageName + "(" + props.instructionData.VesselCode + ")", value: props.instructionData.VoyageNum }], "QuickFormVoyageNum")
                ...
                if (props.instructionData.FinalDestinationHandler) {
                    props.setValue("SalesInvoice[FinalDestinationHandler]", { CompanyUUID: props.instructionData.finalDestinationHandler.CompanyUUID, CompanyName: props.instructionData.finalDestinationHandler.CompanyName })
                }
                ...
                if (props.instructionData.POLHandlingOfficeCode) {
                    ...
                    props.setValue("SalesInvoice[POLAgentName]", props.instructionData.pOLHandlingOfficeCode.company.CompanyUUID)
                    props.setValue("SalesInvoice[POLAgentROC]", props.instructionData.pOLHandlingOfficeCode.company.ROC)
                ...
                if (props.instructionData.PODHandlingOfficeCode) {
                    ...
                    props.setValue("SalesInvoice[PODAgentName]", props.instructionData.pODHandlingOfficeCode.company.CompanyUUID)
                    props.setValue("SalesInvoice[PODAgentROC]", props.instructionData.pODHandlingOfficeCode.company.ROC)
    ...
    return (
        <div className={`DetailFormDetails Instructions`}>
            <div className="salesinvoice-instruction-form">
